...
$.reject = function(opts) {
	var opts = $.extend(true,{
		reject : { // Rejection flags for specific browsers
			...
			chrome: true, safari: true // Covers MSIE 5-6 (Blocked by default)
			/*
		...
		header: 'Your browser is not currently supported with DAN Membership Forms',
		// Paragraph 1
		paragraph1: 'You are currently using an unsupported browser.   '+
					' '+
					' ',
		// Paragraph 2
		paragraph2: 'Please install one of the optional browsers below to proceed.',
		close: true, // Allow closing of window
		// Message displayed below closing link
		closeMessage: ' ',
		closeLink: 'Close This Window and Return Home', // Text for closing link
		closeURL: 'http://www.danasiapacific.org/index.php', // Close URL
		...
		imagePath: '../_images/', // Path where images are located
