...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      ...
      <h1><em>Welcome to the Divers Alert Network (DAN) Asia-Pacific</em></h1>
        ...
        <p id="btjoinnow" onMouseOver="self.status=document.referrer;return true" href="http://join.danap.org"><a id="btjoinnow" href="http://join.danap.org" onMouseOver="self.status=document.referrer;return true">BACK</a>

        <a id="back" href="http://join.danap.org">JOIN DAN NOW</a></p>
