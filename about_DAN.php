...
<title>DAN Divers Alert Network Asia-Pacific : Scuba Diving Membership and Insurance for Divers</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      <div id="content">
        <h1> Welcome to DAN Asia-Pacific</h1>
        <p>The Divers Alert Network (DAN)  is a not-for-profit, member-based, dive safety association. DAN Asia-Pacific&rsquo;s region  of responsibility is extensive and includes India, Korea, South East Asia,  China and Australia. Worldwide, there are more than 300,000 DAN Members, and  DAN has handled in excess of 60,000 emergency calls.<br />
          <br />
With 30+ years helping divers worldwide, DAN are the experts in diving accident  management. Wherever members live or dive around the world they have peace of  mind knowing that DAN is available 24-hours a day, 7 days a week to assist in  the event of an accident.<img src="_images/groupofdivers.jpg" alt="DAN Membership and Insurance. A Must for Scuba Divers" width="221" height="156" class="imgRight" /></p>
        <h2>DAN's Mission Statement</h2>
        <p><em>&ldquo;To be the most  recognised and trusted organisation worldwide in the fields of diver safety and  emergency services, health, research and education of its members, instructors,  supporters and the recreational diving community at large.&rdquo;</em></p>
        <ul>
          <li><a href="About_DAN/DAN_magazine.php">Alert  Diver Asia-Pacific Edition</a></li>
		  <li><a href="About_DAN/DAN_founder_welcome.php">Welcome from DAN AP's Founder</a> </li>
		  <li><a href="About_DAN/DAN_history.php">History  of DAN </a></li>
		  <li><a href="About_DAN/asiapacific_countries.php">Countries with the Asia-Pacific</a> </li>
          <li><a href="About_DAN/board_of_directors.php">DAN Asia-Pacific Board of Directors</a></li>
          <li><a href="About_DAN/dan_financials.php">DAN AP Financials</a> </li>
          <li><a href="_pdf/DAN_Constitution.pdf">DAN Constitution</a> </li>
        </ul>
      </div>
      <!-- InstanceEndEditable --> 
	  	<div class="clear cx"><!-- --></div>
