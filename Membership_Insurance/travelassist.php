<?php $thisPage="MEMBERSHIP travelassist"; ?>
<?php
...
<title>DAN Divers Alert Network Asia-Pacific : TravelAssist Benefits</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>DAN TravelAssist Benefits</h1>
	      <p>As part of DAN Asia-Pacific  Membership, our Members automatically gain access to a broad range of TravelAssist  benefits.&nbsp; A key TravelAssist benefit is  Emergency Evacuation Coverage.&nbsp; </p>
	      <p>A DAN Member, who is travelling more  than 80km (measured directly by air) from home, can be evacuated from almost anywhere in the world to an  appropriate medical facility, in the event of an accident or illness. Up to  US$150,000 per person (if a Family Membership) evacuation cover is valid <strong>whether  the accident is diving related or not</strong> during any travel trip  away from the Member's residence.</p>
	      <p><em>Note: The 80km evacuation rule is  waived only in the case of diving emergencies where a Member has elected to take out  Optional Dive Injury (Treatment) Insurance.</em></p>
	      <p>In addition to Emergency Evacuation  Coverage, TravelAssist benefits also include (but are not limited to):</p>
	      <table border="0" cellspacing="0" cellpadding="0">

            <tr>
              <td width="284" valign="top"><p class="sred">Travel Benefits</p>
                <ul><li>Pre Trip Information</li>
                <li>Return of Travel Companion and/or Dependant Children</li>
                <li>Visit    of a Family Member or Friend</li>
              </ul>			   </td>
              <td width="284" valign="top"><p class="sred">Personal Benefits</p>
                <ul>
                  <li>Return    of Vehicle</li>
                  <li>Translator    and Interpreter Referral</li>
                <li>Emergency    Cash Advance</li>
              </ul></td>
            </tr>

            <tr>
              <td width="284" valign="top"><p class="sred">Medical Benefits</p>
                <ul><li>Emergency    Medical Evacuation</li>
                <li>24-Hour    Medical Information &amp; Assistance</li>
              </ul></td>
              <td width="284" valign="top"><p class="sred">Legal Benefits</p>
                <ul><li>Referrals</li>
                <li>Assistance</li>
              </ul></td>
            </tr>
          </table>
	      <p><a href="../_pdf/travelassist.pdf">Read the Full Benefits, Conditions &amp; Exclusions of TravelAssist</a></p>
	      <p><a href="../Membership_Insurance/excludedcountries.php"> View Countries Excluded From TravelAssist Benefits</a></p>
		  <a id="back" href="javascript:history.go(-1)" onMouseOver="self.status=document.referrer;return true">BACK</a>
	      <p><a href="../Membership_Insurance/benefits.php"></a></p>
	    </div>
	    <!-- InstanceEndEditable --> 
	  	<div class="clear cx"><!-- --></div>
    </div>
