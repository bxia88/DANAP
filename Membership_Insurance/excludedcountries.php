<?php $thisPage="MEMBERSHIP excludedcountries"; ?>
<?php
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>Regions Currently Excluded From DAN TravelAssist Benefits</h1>
	      <p>It is the responsibility of the Member to inquire with DAN  TravelAssist as to whether a country is &quot;open&quot; for assistance prior  to his/her departure. </p>
	      <p>The following list will provide some guidance but must not be  used as a definitive listing as it will change from time to time. </p>
	      <p>Tibet, Antarctica, the Arctic Circle, Mongolia, Muritania,  Guinea, Sierra Leone, Liberia, Nigeria, Rwanda, Angola, Bosnia, Cuba, Bhutan, Haiti,  Somalia, Yemen, Afghanistan, Kyrgystan, Tajikistan, and Russia east of the  Urals.</p>
	      <p class="emstrong">Please contact DAN  TravelAssist to confirm which countries are excluded at a particular point in  time. TravelAssist can be  contacted on +1-919-684-3483 (Collect).</p><a id="back" href="javascript:history.go(-1)" onMouseOver="self.status=document.referrer;return true">BACK</a>
	      <p>&nbsp;</p>
        </div>
	    <!-- InstanceEndEditable --> 
	  	<div class="clear cx"><!-- --></div>
