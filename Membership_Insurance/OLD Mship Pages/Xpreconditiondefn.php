...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>Predisposing Medical Condition</h1>
	      <p><span class="strong">Predisposing Medical Condition</span> means any medical  condition existing prior to the effective date of insurance that may predispose  the Member to a diving accident.&nbsp; Such  Predisposing Medical Conditions include, but are not limited to, epilepsy,  diabetes, any other condition that could cause a person to become unconscious  underwater, asthma, pulmonary disease or injury, cardiovascular disease,  cardiac conditions, previous decompression illness and major surgery.</p>
	      <p><span class="strong">Pre-existing Condition</span> means a medical condition that existed and for which diagnosis, treatment 
		   and/or medication was received within the 12 Months immediately preceding the  effective date of insurance.</p>
