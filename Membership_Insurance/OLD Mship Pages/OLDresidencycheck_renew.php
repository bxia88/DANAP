<?php $thisPage="MEMBERSHIP residencycheck"; ?>
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <div class="center"><h1>DO YOU LIVE IN AUSTRALIA?</h1></div>
		            <div class="center"><span class="emred">If you live in another country within the Asia-Pacific, please select &quot;No&quot;</span></div>
          <div class="center yesno">
		    <table width="600" height="90" border="0">
            <tr>
              <td><div align="center"><a id="yes" href="../Membership_Insurance/austrescheck_renew.php">YES</a></div></td>
              <td><div align="center"><a id="no" href="../Membership_Insurance/osrescheck_renew.php">NO</a></div></td>
            </tr>
          </table></div>

          <p><strong>IMPORTANT NOTE:</strong></p>
          <p><strong>Any signs or symptoms that appear within 24 to 48 hours of diving should be suspected of being diving-related.</strong><br />
            It is important to get specialist diving medical advice as soon as possible and<strong class="red"> not to dive again until this is done</strong>. Call a DAN-supported <a href="../emergency/hotline_numbers.php">diving emergency hotline</a> for advice.</p>
          <h2>RENEWING MEMBER FREQUENTLY ASKED QUESTIONS</h2>
          <p><a href="../Membership_Insurance/renewal_faq.php">CLICK HERE</a> for FAQ's relevant to Renewing Members.  </p>
