...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          ...
          <h5>Do you have a pre-existing / pre-disposing medical  condition, serious injury or have you suffered from decompression illness? <a href="medcon_info.php">READ MORE</a></h5>

          <h5>Are you a non-National of Australia? <a href="non_nat_aust.php">LEARN MORE</a></h5>

          <h5>Do you intend to travel or live outside Australia for longer than 3 months? <a href="non_nat_aust.php">LEARN MORE</a><span class="em"><br /></h5>


	        <br />

            <h5><span class="sred style2">RENEW YOUR  DAN  MEMBERSHIP  </span></h5>
            
		<div class="center">
	        <table width="350" height="90" border="0">
            <tr>
              <td><div align="center">
                <p><a id="applyonline" href="https://www.danasiapacific.org/main/mforms/au-r_membershipform.php">Click Here  To Apply On-Line</a></p>
              </div></td>
          ...
          <p class="fine"><a href="http://www.adobe.com/products/acrobat/readstep2.html"><img src="../_images/get_adobe_reader.gif" alt="Get Acrobat Reader" width="112" height="33" border="0" /></a></p>
