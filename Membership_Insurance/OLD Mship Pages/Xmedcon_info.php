<?php $thisPage="MEMBERSHIP familydefinition"; ?>
<?php
...
<title>DAN Divers Alert Network Asia-Pacific : Membership and Insurance for Scuba Diving</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h2>Do you have a pre-existing / pre-disposing medical  condition, serious injury or have you suffered from decompression illness?</h2>
	      ...
	      <p><a href="../_pdf/SPUMS_Medical_2011.pdf">Click here to download the SPUMS medical examination form</a><a id="back" href="javascript:history.go(-1)" onMouseOver="self.status=document.referrer;return true">BACK</a>          </p>
	      <p>&nbsp;</p>
        </div>
	    <!-- InstanceEndEditable --> 
	  	<div class="clear cx"><!-- --></div>
