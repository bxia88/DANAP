...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          ...
          <h3>Are you a non-National of the Asia-Pacific? <a href="non_nat.php">LEARN MORE</a></h3>
          <h3>&nbsp;</h3>
          <p class="sred style1">APPLY FOR DAN  MEMBERSHIP &amp; INSURANCE <br />
            <span class="style2">(ON-LINE OR FAX)</span></p>
            ...
            <tr>
              ...
              <td><h4 align="center"><a href="../_pdf/osfaxform.pdf">Click here to download a MEMBERSHIP &amp; INSURANCE APPLICATION FORM<br />
              </a><a href="../_pdf/osfaxform.pdf">To fax to DAN </a></h4>
              </td>
            </tr>
          </table>	    
		  </div>
