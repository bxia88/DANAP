...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
		  ...
		  <p>MPORTANT: The optional Dive Injury Insurance Plans are per  person and can only be purchased at the time of becoming a DAN Asia-Pacific  Member.</p>
		  ...
		  <div class="center"><table width="350" height="90" border="0">
            ...
            IMPORTANT NOTE:</strong> <strong>Any signs or symptoms that appear within 24 to 48 hours of diving should be suspected of being diving-related.</strong> 
    ...
    <div class="center">
            ...
            <tr>
              <td><div align="center"><a id="membership" href="osdec.php">YES</a></div></td>
              <td><div align="center"><a id="membershipplus" href="osplans1.php">NO</a></div></td>
            </tr>
          </table></div>
 </div>   
