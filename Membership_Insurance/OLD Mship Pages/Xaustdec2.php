...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          ...
          <h5>Do you intend to travel or live outside Australia for longer than 3 months? <a href="non_nat_aust.php">LEARN MORE<br />
          </a><span class="em">
	      </span><br />
	        <br />
          <span class="sred style2">APPLY FOR DAN  MEMBERSHIP  (ON-LINE OR FAX)</span> </h5>
          <h6><strong>BROWSER PROBLEM</strong> (including, but not limited to, Safari &amp; Google Chrome) </h6>
	      ...
	      <div class="center">
            ...
            <tr>
              <td><div align="center">
                ...
                <img src="/_images/geotrust.jpg" width="114" height="53" alt="GeoTrust" class="imgLeft"/>

<!-- webbot  bot="HTMLMarkup" endspan -->
              </div></td>
              <td class="strong">OR</td>
              <td><h4 align="center"><a href="../_pdf/austfaxform.pdf">Click here to download a MEMBERSHIP APPLICATION FORM To fax to DAN </a></h4></td>
            </tr>
          </table>	    
 			<div align="right"></div>
		  </div>  
