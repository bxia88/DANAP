...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
		  <h1>Would you  like to add a Dive Injury (Treatment) Insurance Plan to your DAN Membership?</h1>
		  ...
		  <p>		    Just a reminder, DAN Membership  includes Worldwide Emergency Evacuation but does <strong>not</strong> cover treatment costs. The<em> optional</em> Dive Injury Insurance Plans provide  coverage for treatment and certain other costs associated with covered dive  accidents (within the limits of each plan). <em>The  Dive Injury Insurance Plans are per person and can only be purchased</em> <strong><em>at the time of renewing</em></strong><em> your DAN Membership.</em><em><br />
		  ...
		  <div class="center"><table width="350" height="90" border="0">
            ...
            <tr>
              ...
              <td><div align="center"><a id="yes" href="osplansrenew.php">YES</a></div></td>
	        ...
	        <p align="left"><strong>IMPORTANT NOTE:</strong> <strong>Any signs or symptoms that appear within 24 to 48 hours of diving should be suspected of being diving-related.</strong> 
    ...
    <div class="center">
            ...
            <tr>
              ...
              <td><div align="center"><a id="membership" href="osdec_renew.php">YES</a></div></td>

              <td><div align="center"><a id="membershipplus" href="osplansrenew.php">NO</a></div></td>
