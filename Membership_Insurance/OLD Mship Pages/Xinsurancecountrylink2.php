<?php $thisPage="MEMBERSHIP insurancecountrylink"; ?>
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>Are You Living In Australia?</h1>
          <div class="center yesno">
		    <table width="600" height="90" border="0">
            <tr>
              <td><div align="center"><a id="yes" href="../Membership_Insurance/austinstable.php">YES</a></div></td>
              <td><div align="center"><a id="no" href="../Membership_Insurance/osinstable.php">NO</a></div></td>
            </tr>
          </table></div>
