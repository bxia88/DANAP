...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          ...
          <p><em>Dive Injury Insurance is underwritten by Accident &amp;  General Insurance (AGI) for residents outside Australia. If you have any other  pre-existing insurance policies your DAN policy becomes secondary coverage and  will pay up to 100% of all remaining eligible expenses. If DAN is your only  insurance policy it will pay up to 100% of all eligible expenses.</em></p>

          <h5><a href="renewal_faq.php">Review the Renewing Member Frequently Asked Questions</a></h5>

          <h5><a href="osinstable.php">Review each of the Dive Injury (Treatment) Insurance Plans </a></h5>

          <h5><a href="osinsuranceexclusions.php">Read the Conditions &amp; Exclusions for Dive Injury Insurance</a></h5>

          <h5><a href="../_pdf/osinsurancedoc.pdf">Read the Policy Insurance Document</a></h5>

          <h5><a href="medcon_info.php">Do you have a Pre-existing Medical Condition, Serious Injury or have suffered from Decompression Illness? Read More Here</a> </h5>

          <h5><a href="non_nat.php">Are you are a non-National of the Asia-Pacific? Read More Here</a><br /><br />

          </h5>

          <p class="sred style1">RENEW YOUR  DAN  MEMBERSHIP &amp; INSURANCE          </p>
          ...
          <div class="center">
            ...
            <tr>
              <td><div align="center">
                <p><a id="applyonline" href="https://www.danasiapacific.org/main/mforms/os-r_membershipform_i.php">Click Here  To Apply On-Line</a></p>
              </div></td>
              <td class="strong">OR</td>
              <td>
              <div align="center">
              <p><a id="download" href="../_pdf/osfaxform.pdf">DOWNLOAD FORM</a></div></p></td>
            </tr>
            <tr>
              <td colspan="3">
              <img src="/_images/geotrust.jpg" width="114" height="53" alt="GeoTrust" class="imgLeft"/></td>
              </tr>
          </table>	    
		  </div>
	        ...
	        <a href="http://www.adobe.com/products/acrobat/readstep2.html"></a>
	      ...
	      <p>The Dolphin browser is compatible with  DAN AP's online application forms. This brower can be downloaded FREE from the App Store.</p>
	      <p class="fine">The FAX form requires Acrobat Reader, click on the image to download Acrobat Reader</p>

	      <p><a href="http://www.adobe.com/products/acrobat/readstep2.html"><img src="../_images/get_adobe_reader.gif" alt="Get Acrobat Reader" width="112" height="33" border="0" /></a></p>
