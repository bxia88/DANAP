...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      <div id="content">
        <h1>Help Support DAN</h1>
        <img src="_images/Fish_&_Sun_Rays_2.jpg" width="150" height="211" class="imgRight" />
        <p>DAN Asia-Pacific has two programs that  individuals and businesses can get involved with that will enable you to support DAN and help promote our important dive safety message within the recreational diving community. We encourage you to learn more about these program below. </p>
        <ul>
          <li>DAN Asia-Pacific <a href="DAN_Sponsors_Supporters/sponsors.php">Sponsor Program</a> </li>
          <li>DAN Asia-Pacific <a href="DAN_Sponsors_Supporters/DAN_supporters.php">Supporter  Program</a> </li>
        </ul>
        <p>If you have any questions please send  us an <a href="mailto:marketing@danasiapacific.org">email</a>. <br />
        </p>
        <h1>View DAN's Sponsors &amp; Supporters</h1>
        <p align="left"><a href="DAN_Sponsors_Supporters/sponsors_supporters.php">Click Here</a> to view DAN's Sponsors and Supporters. <br />
        </p>
        </div>
      <!-- InstanceEndEditable --> 
	  	<div class="clear cx"><!-- --></div>
