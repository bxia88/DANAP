...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      <div id="content">
        <h2>2013 Dive Events </h2>
        <h6><a href="http://www.chinadiveshow.com"></a><a href="http://www.odex.com.au"><img src="_images/ODEX13_logo.jpg" alt="ODEX 2013" width="160" 
	height="180" border="0" class="imgRight" /></a>ODEX (Sydney), 7 - 8 September</h6>
        <p>The Sydney  International Scuba &amp; Underwater Sports Expo will take place at the Sydney  Olympic Aquatic Centre. As the name suggests this unique event combines scuba  diving plus underwater rugby and hockey, fin swimming, world-series free  diving, static and dynamic apnea and more. </p>
        <p>As well the Expo will enable  visitors to check out the latest gear, book a discounted holiday, talk to  experts, listen to keynote speakers and more.</p>
        <p> For more information <a href="http://www.odex.com.au">CLICK HERE</a>. <br />
        </p>
