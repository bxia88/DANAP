...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
        <div id="content">
          <h1>謝謝您</h1>
          <p>您的申請書己呈交到潛水人警報網絡亞太區作審定，一旦申請成功  ，便進行辦理程序。正常的辦理程序是一個星期，並且會在收到款  項之後立即進行登記。有些地區，郵政服務必須要幾星期才能遞到  ，請容許郵政局有足夠的時間來遞送您的會員包。    </p>
<p>申請者會給予電郵通知(假使您有填上聯絡電郵)您的會員編號、資  料和DAN緊急事故聯系資料。 </p>
          <p>潛水平安，    </p>
          <p>潛水人警報網絡亞太區團隊</p>
          <p>&nbsp; </p>
