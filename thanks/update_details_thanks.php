...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
        <div id="content">
          <h1>Thank You</h1>
          <p>Your request to update your contact details has successfully been submitted. </p>
          <p>The DAN Asia-Pacific Team will ensure your details are updated on the DAN Asia-Pacific Member Database. </p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
