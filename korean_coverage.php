...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      <div id="content">
        <h1>DAN AP 회원 &amp; 사고 보험 내역 </h1>
        <p>DAN AP 회원에게 12 개월 전 세계적인 응급 후송 서비스가 
제공 되며 다이빙으로 일어난 사고뿐만 아니라 비다이빙 
응급 상황의 경 우에도 혜택을 <br />
보장 
받 을 수 있습니다.</p>
        <p>DAN AP 는 총 세 가지 사고 보험을 제공하며 규정 내 다이빙 시 발생된 사고 치료비 그리고 관련된 비용에 관한 보장을 받으실 수 있습니다.</p>
        <p> 각 보험에 관한 자세한 사항은 DAN AP 홈페이지를 참고하십시오.<br />
        </p>
        <h1><a href="_pdf/korean_comparison_table.pdf">다이빙 사고보험 내역 비교표  (Comparison Table)</a><br />
          <br />
        <a href="_pdf/Korean_Application.pdf">댄 아시아-태평양에 가입하십시오 (Join) </a><a href="_pdf/Korean_Application.pdf"></a><br />
        <br />
        <a href="_pdf/Policy_Doc_Korean.pdf">댄 사고 보험 약관  (Policy Document) <br />
        </a><br />
        <a href="_pdf/TravelAssist_Korean.pdf">댄 트레블어시스트(TravelAssist) 약관</a><a id="back" href="javascript:history.go(-1)" onMouseOver="self.status=document.referrer;return true">BACK</a>      </h1>
      </div>
      <!-- InstanceEndEditable --> 
	  	<div class="clear cx"><!-- --></div>
    </div>
