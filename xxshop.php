...
<title>DAN Divers Alert Network Asia Pacific: DAN Asia-Pacific's Online Product Catalogue</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      <div id="content">
        <h1>DAN Asia-Pacific's Online Product Catalogue</h1>
        <p>Our range of products  includes a variety of oxygen and first aid equipment, books on diving  medicine, health and safety, plus DAN merchandise. </p>
        <p>We have created an informative on-line product catalogue to allow you to conveniently view the <br />
        DAN AP Product range. </p>
        <p>The  shop has been designed to enable visitors to submit an inquiry prior to  placing an order. Please refer to &ldquo;online inquiry &amp; ordering information&rdquo; for further  details regarding why the shop has been designed in this manner. </p>
        <p>Follow the links below to check out the full range of<span class="emstrong"> DAN Products</span>, including our 
		<span class="emstrong">Featured Product</span>.</p>
        <ul>
          <li>
            <h4><a href="shop/oxygen.php">Oxygen Equipment</a></h4>
          </li>
          <li>
            <h4><a href="shop/firstaid.php">First Aid Equipment</a></h4>
          </li>
          <li> 
            <h4><a href="shop/books.php">Books</a></h4>
          </li>
          <li>
            <h4><a href="shop/merchandise.php">DAN Merchandise</a></h4>
          </li>
          <li>
            <h4><a href="shop/featuredproduct.php">Featured Product</a></h4>
          </li>
          <li>
            <h4><a href="shop/orderonline.php">Order Online</a></h4>
          </li>
        </ul>
      </div>
      <!-- InstanceEndEditable --> 
