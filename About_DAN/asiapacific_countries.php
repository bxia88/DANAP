...
<title>DAN Divers Alert Network - Countries within the Asia-Pacific</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>Countries within the Asia-Pacific</h1>
	      <p>If you reside in one of the following countries you can apply for  Membership and Dive Injury Insurance with DAN Asia-Pacific:</p>
	      <p>	        Australia, Brunei, Burma, Cambodia, China, Fiji, Hong Kong, India,  Indonesia, Korea, Malaysia, New Zealand, Papua New Guinea, Philippines,  Singapore, Solomon Islands, Sri Lanka, Taiwan, Thailand, Vanuatu and Vietnam.</p>
	      <p>&nbsp;</p>
