<?php $thisPage="INSIDE alertdiver"; ?>
...
<title>DAN Divers Alert Network Asia-Pacific : DAN's Dive Health and Safety Magazine</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      <div id="content">
          <h1>DAN Asia-Pacific's<em> Alert Diver</em>  Magazine</h1>

	      <p>All DAN Asia-Pacific Member's receive our   quarterly <span class="em">Alert Diver</span> magazine, which is the only dedicated dive health and safety magazine within the Region. </p>
	      <h2>More Benefits for Members! </h2>
        <p> Thanks to DAN AP's  Media Partnership with <em>ScubaDiver AUSTRALASIA </em>our Members receive even greater benefits, with free online access to <em>ScubaDiver AUSTRALASIA</em> magazine. </p>
	      <p><em>Scuba Diver AUSTRALASIA</em> is published four times a year 
and is full of fascinating  content – compelling, relevant information and images from some of the world’s  best underwater photographers. </p>
	      <h1>Invitation to Trial a Free Issue of <em>Alert Diver Asia-Pacific </em>Magazine</h1>
        <p>If you would like to trial an issue of <em>Alert Diver</em> send us an <a href="mailto:marketing@danap.org">email</a>.</p>
	      <ul>

	        <div align="center">
	          <h2>Quarter 1 Issue for 2016</h2>
	          <img src="../_images/ad_sdaa_1_2016.jpg" alt="Alert Diver Quarter 3, 2015" width="394" height="276"/><a id="back" href="javascript:history.go(-1)" onMouseOver="self.status=document.referrer;return true">BACK</a>	    </div>
        </ul>
	    </div>
	    <!-- InstanceEndEditable --> 
	  	<div class="clear cx"><!-- --></div>
