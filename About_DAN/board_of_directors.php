...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>DAN Asia-Pacific Board of Directors </h1>
	      <p>Following are the Members of the DAN Asia-Pacific Board of Directors</p>
	      <ul>
	        <li>John Lippmann OAM</li>
	        <li>David Natoli</li>
	        <li>Dr David Wilkinson</li>
	        <li>Stan Bugg</li>
	        <li>Mick Jackson</li>
	        <li>Malcolm Hill </li>
            <li>Tom Wodak </li>
	        <li>Nicholas Cheong </li>
	      </ul>
	      <p>&nbsp;</p>
