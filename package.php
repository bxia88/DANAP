...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      ...
      <h3 class="style1">All for one ... one price for all! <br />
      </h3>
      <h1>1 YEAR DAN Asia-Pacific Membership +<br />
        1 YEAR Subscription to Scuba Diver<br />
        AUSTRALASIA + OCEAN PLANET for<br />
      just S$90!</h1>
      <p>A brand new offer from Scuba Diver 
        AUSTRALASIA + OCEAN PLANET and 
        DAN Asia-Pacific now lets you get 
        your dive safety, travel, education,<br />
        entertainment, lifestyle and underwater 
        photography, in one fell swoop and for a 
        killer price.</p>

          
        <p>Don’t miss out! If you live in the Asia Pacific region, and would love to get a DAN Asia-Pacific Membership and a subscription to 
Scuba Diver AUSTRALASIA + OCEAN PLANET, 
bundled together for the crazy price of just SGD 90 send us an <a href="mailto:marketing@danap.org">email</a> with your name and email address. </p>
        <p>One of our Team will contact you to complete the purchase. <br />
        </p>
        <!-- InstanceEndEditable --> 
	  	<div class="clear cx"><!-- --></div>
    </div>
