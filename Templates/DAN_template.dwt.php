...
<div id="croot">
 	...
 	<div id="content"><!-- TemplateBeginEditable name="testimoinals_block" -->
 	  <div id="testimonials"><?php include("../_includes/01a_testimonials.php"); ?></div>
      <div id="body_content">
 	<!-- TemplateEndEditable --><!-- TemplateBeginEditable name="content_body" -->

      <h1>This is Heading 1, example, example, example, example, example, example, example, example, example, e	xample</h1>
          <p>This is &quot;Paragraph&quot; text. Example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example, example.</p>
