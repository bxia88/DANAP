...
<?php	} ?>
			  <tr>
				...
				<td class="cobll" bgcolor="#FFFFFF" height="34"><input type="text" size="20" name="ordid" value="<?php print trim(@$_POST["ordid"])?>" /></td>
			  </tr>
			  <tr>
			    <td class="cobhl" width="40%" bgcolor="#EBEBEB" height="34" align="right"><strong><?php print $xxEmail?> : </strong></td>
				<td class="cobll" bgcolor="#FFFFFF" height="34"><input type="text" size="30" name="email" value="<?php print trim(@$_POST["email"])?>" /></td>
			  </tr>
			  <tr>
