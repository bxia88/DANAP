...
$xxForPas='Forgot your password?';
$xxNoOrd='No matching inquiries.';
...
$xxStaVw="View Inquiry Status";
$xxStaCur="This is the current status for your inquiry number";
$xxStatus="Status";
$xxStaErr="The following error occurred";
$xxStaEr1="Please enter a valid inquiry id.";
$xxStaEr2="Sorry, we could not find an inquiry matching that inquiry id and email address. Please try again.";
$xxStaEnt="Please enter your inquiry id and the email address used on the inquiry.";
$xxDate="Date";
$xxTime="Time";
...
$xxTermsCo="<strong>Please click here if you are in acceptance of our terms and conditions.</strong><br />To review our terms and conditions, please <a href='javascript:showtermsandconds();'>click here</a>.";
...
$ssIncTax="(%s <font size='1'>Inc. GST</font>)";
$xxMCCO="Checkout";
...
$xxNoGfCr="The discount number you entered (%s) was not found, has expired or is not applicable. Please <a href=\"javascript:history.go(-%s)\"><strong>click here</strong></a> if you wish to go back and try again.";
$xxListPrice="<font color='#999999'><strong>List Price:</strong> <strike>%s</strike></font>";
$xxHomeURL="categories.php";
$xxHome="Product Catalogue";
$xxOutStok="Out&nbsp;of&nbsp;Stock";
$xxOutState="Outside Australia";
$xxState="State (Australia)";
$xxAllSta="State";
$xxNonState="State (Non Australia)";
$xxCntryTxt="Australia";
$xxPlsSel="Please Select...";
$xxAddOrd="has been added to your inquiry.";
$xxPlsWait="Please wait while we return you back to the products or ";
$xxClkHere="click here";
$xxSrryItm="Sorry, the item";
$xxIsCntly="is currently";
$xxOutStck="out of stock.";
$xxTemprly="temporarily";
$xxNotChOu="&quot;Temporarily&quot; means that the product has been added to someones shopping cart, but they have not checked out. If they do not complete the inquiry, the product will be free in";
...
$xxCstDtl="<br />Please Enter Your Contact Details Below.<br /><br />NOTE: TO RECEIVE MEMBER PRICES YOU MUST INCLUDE YOUR MEMBER NUMBER IN THE SPACE PROVIDED.<br />";
...
$xxChkCmp="<br />FINALISE INQUIRY<br /><br />Below is the total of the Member prices (excluding freight and GST) for the products you have selected for your inquiry. Once you submit your inquiry a Member of the DAN Team will respond with an accurate quote for the items you have selected.<br />&nbsp;";
...
$xxIfPres="(if present)";
$xxMstClk="PLEASE CLICK THE BUTTON BELOW TO SUBMIT YOUR INQUIRY.";
$xxTrnRes="Transaction Result";
$xxOrdNum="Inquiry Number";
...
$xxTotal="Total";
$xxDelete="Delete";
$xxCntShp="Continue Browsing the DAN AP Website";
...
$xxAlPrCa="Alternatively, you can view products according<br />to category by following the links below.";
$xxNoPrds="No products are currently available.";
$xxClkPrd="Follow the links below to check out the full range of DAN Products and the Online Inquiry and Ordering Information.";
...
$xxPrNm="Product Name";
$xxUnitPr="Unit Price";
$xxOrdTot="Inquiry Total";
$xxOrdStr="Order at your store";
$xxTnxOrd="Thank you for your inquiry";
$xxTouSoo="We will be in touch as soon as possible about your inquiry, the details of which are as follows:";
...
$xxThnks="Thank You.";
$xxThkYou="<hr>";
$xxThkErr="<br /><strong>Sorry, there seemed to be an error !</strong><br /><br />If you need any help with your inquiry, then please be sure to contact us.<br /><br />";
...
$xxOrdNIs="Your inquiry number is";
