...
function writepreviousnextlinks(){
	...
	if($previousid != ""){
		if($previousidstatic)
			print '<a href="' . cleanforurl($previousidname) . '.php' . (@$_GET['cat'] != '' ? '?cat=' . @$_GET['cat'] : '') . '">';
		else
			print '<a href="proddetail.php?prod=' . $previousid . (@$_GET['cat'] != '' ? '&cat=' . @$_GET['cat'] : '') . '">';
	}
	...
	if($nextid != ""){
		if($nextidstatic)
			print '<a href="' . cleanforurl($nextidname) . '.php' . (@$_GET['cat'] != '' ? '?cat=' . @$_GET['cat'] : '') . '">';
		else
			print '<a href="proddetail.php?prod=' . $nextid . (@$_GET['cat'] != '' ? '&cat=' . @$_GET['cat'] : '') . '">';
	}
