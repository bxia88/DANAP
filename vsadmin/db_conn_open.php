...
$db_username = "vs452894_shop";  // Your database login username
$db_password = "1Penny2Penny";  // Your database login password
$db_name = "vs452894_shop";      // The name of the database you wish to use
$db_host = "BNE3-0001MY.server-sql.com";   // The address of the database. Often this is localhost, but may be for example db.yoursite.com
