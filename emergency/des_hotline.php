...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>The DAN AP Diving Emergency Service (DES) Hotline</h1>
          <h3>Toll Free 1800 088 200 (within Australia) </h3>
          <h3>User Pays +61-8-8212 9242 (outside Australia)<br />
          </h3>
          <p>DAN currently fully funds the  Diving Emergency Service (DES) Hotline. </p>
	      <p>The DES is a 24-hour diving  emergency hotline based at the Hyperbaric Unit at the Royal  Adelaide Hospital  in Adelaide, South Australia. It is available to all  divers throughout the world. The DES doctors provide this service on a  voluntary basis and DAN Asia-Pacific funds the toll free phone number.</p>
	      <h3><span class="strong">How  a call to the Diving Emergency Service (DES) in Australia is handled.</span></h3>
	      <p>          The DES is not part of DAN; it is  an independent entity. However, DAN utilises the services of the DES doctors  and fully funds the operation of the DES phone.</p>
	      <p>A call to the DES first comes into  the control room of the ambulance service in South Australia. It is answered by a  qualified ambulance officer who takes relevant details and passes the call  through to the on-call DES doctor. The caller is normally able to speak  directly with a hyperbaric doctor within 2 to 5 minutes of calling. The DES  currently handles some 500 calls per year, from all over the world.<br />
              <br />
	        Calls to DES from within Australia  are toll free (call 1800 088 200).&nbsp;  However, calls from outside Australia (+61-8-8212 9242) are  user pays.</p>
			<a id="back" href="javascript:history.go(-1)" onMouseOver="self.status=document.referrer;return true">BACK</a>
	      <p><a href="hotline_numbers.php">Back to Emergency Hotlines Page</a></p>
	    </div>
	    <!-- InstanceEndEditable --> 
	  	<div class="clear cx"><!-- --></div>
    </div>
