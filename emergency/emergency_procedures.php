<?php $thisPage="EMERGENCY procedures"; ?>
...
<title>DAN Divers Alert Network Asia-Pacific  : Membership and Insurance Coverage for Scuba Divers</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>Procedure to Be Used Following an Accident</h1>
	      <p>The  below procedures are to be followed by a DAN Member (or someone acting on  behalf of a Member) in the event of a diving accident or a non-diving  emergency. </p>
	      <p>All members should  familiarise themselves with these procedures in order to minimise any confusion  at the time of an accident. <span class="sred">Click on the below steps to find out more  information.</span></p>
	      <h2>For Diving Emergencies</h2>
	      <p><span class="emstrong">Step 1</span> - Call one of the DAN-Supported  24-Hour dive emergency hotlines. <a href="procedure_step1.php">CLICK HERE</a><br />
              <br />
              <span class="emstrong">Step 2</span> - If the doctor advises that an  evacuation is required, then DAN TravelAssist must be called. <a href="procedure_step2.php">CLICK HERE</a></p>
	      <h2>For Non-Diving Emergencies</h2>
          <p>In the event of a non-diving emergency, the Member should contact<a href="procedure_step2.php"> DAN TravelAssist</a>. This can be done by placing a collect call through the international operator or by dialling direct. The DAN  TravelAssist operator will take relevant details and will arrange for a physician  to be consulted. Following medical advice, TravelAssist will determine the best  course of action and make any necessary arrangements.</p>
