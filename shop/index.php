...
<title>Divers Alert Network - Asia Pacific</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      <div id="content">
        <h1>DAN Shop</h1>
        <h2>Welcome to DAN&rsquo;s On-line  Shop</h2>
        <p>Our product line includes a variety of oxygen and first aid equipment,  books on diving medicine, health and safety, plus 
		DAN merchandise.</p>
        <p>We have created an on-line product catalogue to allow you to order from  the DAN Asia-Pacific product range on-line 
		using secure credit card processing.</p>
        ...
        <ul>
          <li>
            <h4><a href="oxygen.php">Oxygen Equipment</a></h4>
          </li>
          <li>
            <h4><a href="firstaid.php">First Aid Equipment</a></h4>
          </li>
          <li> 
            <h4><a href="books.php">Books</a></h4>
          </li>
          <li>
            <h4><a href="merchandise.php">DAN Merchandise</a></h4>
          </li>
          <li>
            <h4><a href="featuredproduct.php">Featured Product</a></h4>
          </li>
          <li>
            <h4><a href="orderonline.php">Order Online</a></h4>
          </li>
        </ul>
      </div>
      <!-- InstanceEndEditable --> 
