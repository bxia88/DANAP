...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
        <div id="content">
          <h1> Books </h1>
          <p>DAN Asia-Pacific offers a broad collection of books covering a variety of subjects ranging from scuba diving health issues and medicine, first aid and emergency care, to technical diving and more. </p>
          <p><img src="../_images/books.jpg" alt="Books" width="480" height="300" /></p>
          <h2><a href="../products.php?cat=9">DAN Books </a></h2>
