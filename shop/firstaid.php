...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
        <div id="content">
          <h1>First Aid Equipment</h1>
          <p>DAN Asia-Pacific offers a range of first aid and safety products suitable for the diving environment, workplace and home. These include first aid kits, a range of Automated External Defibrillators, resuscitation manikins, oxygen masks, and more. </p>
          <h2><a href="http://www.danap.org/products.php?cat=13">First Aid Kits</a></h2>
          <ul>
            <li> DAN Asia-Pacific General &amp; Aquatic First  Aid Kit</li>
            <li> DAN Asia-Pacific Pro First Aid Kit</li>
            <li> DAN Asia-Pacific Pro Plus First Aid Kit</li>
          </ul>
          <h2><a href="http://www.danap.org/products.php?cat=14">Resuscitation Masks</a></h2>
          <ul>
            <li> DAN Resuscitation Mask &ndash; With Oxygen Inlet</li>
          </ul>
          <h2><a href="http://www.danap.org/products.php?cat=15">Manikins</a></h2>
          <ul>
            <li> Laerdal Little Anne Manikin</li>
            <li> Actar Manikin</li>
          </ul>
          <h2><a href="http://www.danap.org/products.php?cat=16">Other Equipment</a></h2>
          <ul>
            <li> DAN Otoscope</li>
            <li> Automated External Defibrillators (AED&rsquo;s)</li>
          </ul>
