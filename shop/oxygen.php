...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
        <div id="content">
          <h1> Oxygen Equipment </h1>
          <p>DAN Asia-Pacific offers two distinct ranges of Oxygen Equipment.  The DAN Asia-Pacific Oxygen Units have been configured primarily for use within Australia.  In addition, we offer a range of units that have been made to U.S. Standards.  It should be noted that the units made to U.S. standard are generally not sold within Australia. </p>
          <p><strong>To obtain current prices for the below products please email<a href="mailto:training@danap.org"> training@danap.org</a>. </strong></p>
          <h2><a href="http://www.danap.org/products.php?cat=18">Oxygen Units for Use Within Australia</a></h2>
          <ul>
            <li> DAN Asia-Pacific Oxygen Unit</li>
            <li> DAN Economy Unit PLUS (pin-index)</li>
            <li>EMT100 Hose &amp; Mask </li>
            <li> 410 Litre Oxygen Cylinder</li>
          </ul>
          <h2><a href="http://www.danap.org/products.php?cat=19">Oxygen Units for Use Outside Australia (US  Standards)</a></h2>
          <p><em>Note: Purchases will be charged  in AUD$ at the current exchange rate. Prices listed are exclusive of freight and will be confirmed upon product inquiry. </em></p>
          <ul>
            <li> DAN Standard Oxygen Unit </li>
            <li> DAN Charter Boat Unit </li>
            <li> DAN Economy Unit PLUS (CGA-540)</li>
            <li> DAN Dual Cylinder Unit</li>
            <li> Rescue Pak</li>
            <li> Jumbo-D Cylinder</li>
          </ul>
          <h2><a href="oxy_regulators.php">Adaptors for Oxygen Regulators</a></h2>
          <h2><a href="http://www.danap.org/products.php?cat=21">General Safety Equipment </a></h2>
