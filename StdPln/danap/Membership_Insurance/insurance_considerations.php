<?php $thisPage="Dive Injury Insurance Considerations"; ?>
<?php
...
<title>DAN Divers Alert Network - Asia Pacific: Insurance Considerations</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>Dive Injury Insurance Considerations </h1>
	      <p align="justify">When  deciding on the level of optional Dive Injury (Treatment) Insurance to add to your DAN AP  Membership (Emergency Evacuation Coverage), we encourage you to consider:</p>
	      <h2><strong>The type of diving you are certified to undertake </strong> </h2>
	      <p align="justify">For example, if you are certified to dive beyond 50m, and you intend to  do so,  Master Plan would not meet your needs. The Master Plan offers coverage to a maximum depth of  50m. You would need to consider the Preferred Plan. </p>
	      <p align="justify"><em>Note:</em> <em>If you dive deeper  than the Depth Conditions of your plan you risk voiding your coverage.</em></p>
	      <p align="justify">Of course, as a certified diver you can elect to take out a higher level of coverage (e.g. the Preferred Plan) in order to take advantage of  the additional benefits it provides; however it is important that you remain within the limits of your certification. In the event of an accident,  you need to be aware that you might be required to demonstrate that you had appropriate certification and/or experience for the depth, and were using appropriate equipment &amp; breathing gas. </p>
	      <h2>We  strongly encourage you to review the <strong>Dive Injury Insurance Comparison Table</strong>.</h2>
	      <p align="justify"><a href="austinstable.php">Comparison Table For Residents of Australia</a></p>
	      <p align="justify"><a href="osinstable.php">Comparison Table For Residents of the Rest of the Asia-Pacific</a> </p>
	      <p align="justify"><em>Finally, please note that once your coverage has been implemented it is a costly process to change throughout the 12-month coverage period. This is why we strongly encourage  you to consider your coverage needs at the time of application.</em></p>
	      <p align="justify">For more information send us an <a href="mailto:info@danasiapacific.org">email</a> or call +61-3-9886 9166. </p>
	      <p>&nbsp;</p>
