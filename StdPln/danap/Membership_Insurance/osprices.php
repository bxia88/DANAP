<?php $thisPage="MEMBERSHIP osprices"; ?>
<?php
...
<title>DAN Divers Alert Network Asia-Pacific : Insurance Premiums</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>Prices Of Annual Membership & Insurance</h1>
           <p class="subHeading">For applicants living outside Australia but within the Asia-Pacific (excl Japan)           
           </p>
           <h2>Membership</h2>
          <p>12-months coverage that includes Worldwide Emergency Evacuation Coverage, 24-Hours 7 days a week medical assistance, an annual subscription to <span class="em">Alert Diver</span> magazine, access to member-only value-add programs, and much more.</p>
          <p class="strong">Single  Membership = $70 (including AUD$10 postage) </p>
          <p class="strong">Family  Membership = $95 (including AUD$10 postage) </p>
          <h2 class="strong">Optional Dive Injury (Treatment) Insurance</h2>
          <p>Optional Dive Injury Insurance plans are designed to cover the cost of treatment and certain other costs associated with a covered diving accident. They must be purchased at the same time as taking out a DAN  AP Membership.&nbsp;The optional dive injury insurance plans cannot be taken out independent of  Membership.</p>
          <p class="strong">Master Plan = $75</p>
          <p class="strong">Preferred Plan = $125 </p>
          <p class="strong">Preferred Plus Plan = $170 </p>
          <p>Optional <a href="fastprocessing.php">Fast Processing Charge</a> of $10</p>
          <a id="back" href="javascript:history.go(-1)" onMouseOver="self.status=document.referrer;return true">CK</a>
		  <p><a href="osinstable.php">CLICK HERE</a> to view a Comparison Table of the Dive Injury Insurance Plans. </p>
		  <p><a href="insurance_considerations.php">CLICK HERE</a> for issues to consider when choosing a Dive Injury Insurance Plan.</p>
		  <p class="em">NOTE: All Prices  are in Australian Dollars</p>
	    </div>
	    <!-- InstanceEndEditable --> 
	  	<div class="clear cx"><!-- --></div>
    </div>
