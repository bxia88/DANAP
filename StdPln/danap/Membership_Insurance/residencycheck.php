 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          ...
          <div class="center yesno">
            ...
            <tr>
              <td><div align="center"><a id="yes" href="../Membership_Insurance/austrescheck2.php">YES</a></div></td>
              <td><div align="center"><a id="no" href="../Membership_Insurance/osrescheck2.php">NO</a></div></td>
            </tr>
          </table></div>

          <p><strong>IMPORTANT:</strong> <strong>Any signs or symptoms that appear within 24 to 48 hours of diving should be suspected of being diving-related.</strong> 

            It is important to get specialist diving medical advice as soon as possible and<strong class="red"> not to dive again until this is done</strong>. Call a DAN-supported <a href="hotline_numbers.php">diving emergency hotline</a> for advice.</p>
