...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          ...
          <p> <strong>Any signs or symptoms that appear within 24 to 48 hours of diving should be suspected of being diving-related.</strong> 
          ...
          <h3>Special note relating to DAN Standard Plan Insurance policies:</h3>
          <p>As of &lt;&lt;&lt;DATE&gt;&gt;&gt; DAN Asia-Pacific is no longer offering the  Standard Plan as one of the optional Dive Injury Insurance Plans. As a dive health and safety organisation, removing the  Standard Plan was determined to be most beneficial for Members given the plans  limited coverage and with a price only slightly less than the Master Plan. </p>
          <p>The  Master Plan and Preferred Plans offer a much more complete coverage and include all in-water scuba and  snorkelling injuries occurring on a covered dive where the Standard Plan only offered coverage for DCI (Decompression Sickness) and AGE (Arterial Gas Embolisms).&nbsp; </p>
          <p>We continue to encourage members to consider their coverage  needs for the coming year and review the Comparison Table of Dive Injury  Insurance Plans. </p>
          <p>For all Members who have a current Standard Plan, DAN will  continue to provide coverage under the terms of the policy until its expiry  date.</p>
          <p>If you have any questions please contact the DAN  Asia-Pacific office on +61-3-9886 9166.</p>
