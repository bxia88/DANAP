...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      <div id="content">
        <h2>DAN Asia-Pacific Membership Terms &amp; Conditions </h2>
        <p align="justify"><em>These Terms &amp; Conditions are continued from the online DAN AP Membership Application </em></p>
        <p align="justify"><strong>UTMOST GOOD FAITH</strong><br />
          The Assistance obligations, under DAN Membership, are subject to the doctrine  of Utmost Good Faith, which requires that parties to the contract should act  toward each other honestly and fairly, avoiding any attempt to deceive in  assuming and performing contractual obligations. Failure to do so on the part  of the Member may permit DAN to refuse to pay for or arrange assistance or  other services. </p>
        <p align="justify">          The applicant is required to complete the  application fully and in good faith. No cover is provided for any evacuation,  medical, paramedical or other injury benefits resulting from or materially  contributed to, directly or indirectly by any diving or other activity in which  the applicant engaged prior to and up to the time of acceptance of the  application by DAN AP, regardless of the date on which any claim for cover is  made by or on behalf of the applicant.</p>
