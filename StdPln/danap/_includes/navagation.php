...
<ul id="menu1">
  ...
  <li><a href="<?php echo "http://" . $_SERVER['SERVER_NAME']; ?>/dan_membership_insurance.php"<?php if ( strpos($thisPage, "MEMBERSHIP" ) !== false ) echo " id=\"currentpage\""; ?>>Membership & Insurance</a>
	  <ul>
		...
		<li><a href="<?php echo "http://" . $_SERVER['SERVER_NAME']; ?>/Membership_Insurance/insurancecountrylink2.php"<?php if ($thisPage=="MEMBERSHIP insurancecountrylink") echo " id=\"currentpage\""; ?>>Dive Injury Insurance Plans</a></li>
