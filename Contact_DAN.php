...
<!--  <BASE href="http://www.danasiapacific.org/main/">  -->
<!-- InstanceEndEditable -->
</head>
<body> 
<div id="root">
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
        <div id="content">
          <h1>Contact DAN Asia-Pacific</h1>
          <h2>Head Office</h2>
          <p>49A Karnak Road (PO Box    384), Ashburton, Victoria, 3147, Australia<br />
Phone: +61 -3 9886 9166<br />
Fax: +61 -3 9886 9155<br />
Email: <a href="mailto:info@danap.org">info@danap.org<br />
</a><br />
(Divers Alert Network (DAN) Asia-Pacific Limited ABN 67 066 827 129)</p>
          <h2>International  DAN Offices</h2>
          <p><a href="/Contact_DAN/internationaloffices.php">Click Here</a> to locate an International DAN Office</p>
          <h2>Update Your Contact Details</h2>
          <p>If you are a DAN Asia-Pacific Member and would like to update any of your contact details, to ensure you continue receiving the likes of Alert Diver magazine and the e-newsletter, Deeper with DAN, please send an email to <a href="mailto:info@danap.org">info@danap.org</a>.</p>
          <h2>Send DAN Asia-Pacific a Message </h2>
          <p class="em">If you have a comment, question or interesting story, we’d like to hear from you. Send an email to <a href="mailto:communications@danap.org">communications@danap.org</a>. Please allow up to 5 days for a reply.</p>
