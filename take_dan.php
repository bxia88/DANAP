...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      ...
      <h1><em>Wherever you are diving, TAKE DAN with you! </em></h1>

        <h4>DAN AP Membership &amp; Insurance are as important as your mask, fins and air.<img src="_images/Take_DAN.jpg" alt="Take DAN With You!" width="292" height="271" class="imgRight" /></h4>
        <p>DAN provides divers with Worldwide Emergency Evacuation Coverage (<em>DAN Membership</em>) and <em>optional</em> Dive Injury <em>(Treatment)</em> Insurance Plans, to cover  chamber and hospital costs following a covered diving accident. </p>
        <p><a href="https://join.danap.org/">Joining DAN</a>  gives you peave of mind. It allows you to  enjoy your scuba diving knowing you will be looked after in the event of a diving incident, wherever you are in the world,  24-hours a day, 7 days a week.</p>

        <h5><em>Why DAN?</em> With   30+ years  experience helping sick and injured scuba divers worldwide, DAN are the experts in diving accident management. </h5>
