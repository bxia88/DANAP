...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
        <div id="content">
          <h1>Thank You</h1>
          <p align="justify">Your application has been  forwarded to DAN Asia-Pacific for evaluation and, if accepted, for  processing.&nbsp; </p>
          <h2 align="justify">Processing Time </h2>
          <p align="justify">The normal processing time  is within one week and Registration commences once payment has been cleared.&nbsp;</p>
          <h2 align="justify">Membership Pack  </h2>
          <p align="justify">It may take up to two weeks for your pack to leave the DAN AP Office. On top of that, please allow sufficient time for your local  postal services to deliver your Membership Pack, which may also take several weeks  depending on your location.</p>
          <h2 align="justify">Fast Processing Option </h2>
          <p align="justify">If you have chosen the Fast  Processing Option then your application will normally <em>(excluding  payment/medical issues)</em> be processed within 24 hours from the time of  receipt at the DAN Asia-Pacific Office providing it is received during weekdays  (before 2pm Friday).&nbsp; If received on a  weekend your application will be processed within 72 hours.</p>
          <p align="justify">Applicants will be notified  by email <em>(providing you have supplied an email address)</em> of your  Membership Number and Details, and DAN Emergency Contact details.</p>
          <p><em>Safe Diving,</em>
            </p>
          </p>
          <p>The DAN Asia-Pacific Team</p>
          <p>&nbsp; </p>
