...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      <div id="content">
        <h1><strong>사고</strong><strong> </strong><strong>보고서</strong><strong> </strong><strong>제공</strong><strong> </strong><strong>및</strong><strong> </strong><strong>연구활동</strong><strong> </strong></h1>
        <p>DAN 은 다이빙의 안전성을 높이기 위한 노력의 일환으로 다이빙 사고, 상해 및 사망 사례들을 수집하여 보고하고 있습니다.  <strong> </strong></p>
        <p>          또한 다이빙 생리학 분야의 선두주자인 DAN은 레크레이션 스쿠버 다이빙의 안전성에 대한 중요한 의학연구활동을 수행하는 전세계 주요 기관 중 하나이기도 합니다.  </p>
        <p> 이러한 연구활동을 통해 DAN은 다이빙 커뮤니티 전체에 이득이 되고 전세계 레크레이션 다이빙의 안전성을 높여주는 중요한 정보들을 밝혀내고 있습니다. DAN이 없다면, 레크레이션 다이빙 안전성와 관련된 많은 중요한 문제들에 도전하거나 해답을 찾을 수 없을 것입니다.</p>
        <p> 지금까지 DAN의 연구 프로젝트에서 다루어 진 주제들은 당뇨병과 다이빙, 다이빙 후 비행의 영향, 고령화가 다이빙 건강에 미치는 영향 등을 포함하고 있습니다.</p>
        <p> 아래 링크를 클릭하시면 DAN의 사고 보고서, 연구활동 및 여러분의 참여방법에 대해 더욱 자세한 정보를 얻으실 수 있습니다.  </p>
        <p><a href="accident/accident_reporting.php">다이빙 사고 보고서</a></p>
        <p><a href="_pdf/accident_report_form.pdf">다이빙 사고 보고양식</a> </p>
        <p><a href="accident/nfdir.php">비치명적 다이빙 사고 보고 프로젝트(NFDIR) </a> </p>
        <p><a href="accident/dan_research_korean.php">DAN의 연구활동</a> </p>
