...
<title>DAN Divers Alert Network Asia-Pacific  : Diver Below Safety Campaign</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      <div id="content">
        <h1>DAN ID Tag </h1>
        <p>The DAN ID Tag contains the latest Emergency Hotline Numbers. Attach it  to your BCD so you are never without these important  numbers. </p>
        <p>The Tag also identifies you  as a DAN Member to your fellow divers. If you are involved in an incident it will encourage other divers to call DAN for help on your behalf. </p>
        <p>The tag also includes space for your personal details including  Membership Number, emergency contact and any known allergies.</p>
        <p align="center"><img src="_images/IDTag.jpg" alt="DAN ID Tag" width="354" height="296" /></p>
      </div>
	    <!-- InstanceEndEditable --> 
	  	<div class="clear cx"><!-- --></div>
    </div>
