...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      <div id="content">
        <h1>Equalising with Hoods </h1>
        <p align="justify"><a href="http://www.chinadiveshow.com"></a><strong>Q: If I am not wearing a hood I have no problems equalising my ears.   When I wear a hood I always have great difficulty. Why the difference?</strong></p>
        <p align="justify"><strong>DAN Answer:</strong> When we pressurize the middle-ear space using a Valsalva   maneuver or other equalisation technique, the tympanic membrane (ear   drum) bulges outward slightly. If the ear canal is uncovered and can   transmit that pressure, the water in the ear canal moves easily in   response. A hood that fits snugly against the outer ear can greatly   restrict the movement of this water, hampering the diver's ability to   equalize.</p>
        <p align="justify">          One of the easiest remedies to this is to insert a finger   under the hood near the ear, which will allow the water to move more   easily. Another solution some divers choose to implement is to cut a   hole from the inside of the hood, near the ear canal, through the inner   lining and the neoprene but leaving the outer fabric or covering intact.   The hole allows the water to move with little restriction.</p>
        <p align="justify"><em><br />
        Answer provided by DAN's Marty McCafferty, EMT-P, DMT</em></p>
      </div>
      <!-- InstanceEndEditable --> 
	  	<div class="clear cx"><!-- --></div>
    </div>
