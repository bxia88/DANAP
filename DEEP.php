...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      ...
      <h3 class="style1">DEEP 2015 Show Special <br />
      </h3>
      ...
      <p id="btjoinnow" onMouseOver="self.status=document.referrer;return true" href="residencycheck.php"><a id="btjoinnow" href="membership_insurance/residencycheck.php" onMouseOver="self.status=document.referrer;return true">BACK</a></p>
        ...
        <ul>
          <li>You must enter <strong>DEEP2016</strong> in the Referral Code field, which is located on the second screen of the online application.</li>
          <li>Your must submit your application by the<strong> April 10th</strong>  to receive the discount. <em><strong>NOTE: The discount is not applied on the form but when the DAN Team process your application. </strong></em>The price you see on the screen will be the full normal Membership Price. </li>
          <li>You must be a <strong>new</strong> DAN Member. Renewing Members are not eligible for this promotion.</li>
          <li>The discount applies <strong>only to DAN AP Membership</strong>. Optional DAN Dive Injury Insurance is charged at the full normal price. </li>
          <p><br />
