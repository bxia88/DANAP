...
<title>DAN Divers Alert Network Asia-Pacific : Non-Fatal Dive Incidents Reporting Project (NFDIR)</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>Non-Fatal Dive Incidents Reporting Project (NFDIR) </h1>
	      <p align="justify">Fortunately, there  are many more non-fatal dive   incidents and accidents than fatal ones. These can  provide a wealth of   important information about dive accidents and greatly  assist in   determining good preventative measures. </p>
	      <p align="justify">We are keen to receive information on various problems including:   non-fatal  drowning, DCI, equipment problems, oxygen toxicity, boat   encounters, marine  animal injuries, and many others. Please let us know   when you are involved in,  or observe, a potentially dangerous diving   incident.</p>
	      <p align="justify"><em>Note: The incident does not need to have resulted in injury. </em></p>
	      <p align="justify">Project Investigators include DAN Directors and staff: John Lippmann, Scott Jamieson,  Stan Bugg, David Natoli;
	        Dr Richard Harris; and Peter Buzzacott PhD.</p>
	      <p>Reporting can be undertaken online. Please follow the link below to lodge a non-fatal dive incident report. </p>
	      <p><em>We appreciate your support of this valuable project. </em></p>
	      <p><a href="../../nfdir/nfdirform.php">Click here to report a non-fatal diving incident</a></p>
