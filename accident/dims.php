...
<title>DAN Divers Alert Network Asia-Pacific : Diving Incident Monitoring Study</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>Diving Incident Monitoring Study (DIMS)</h1>
	      <p>The DIMS is an on-going  study that collects information about any diving incident, whether or not harm  occurs. There are many more &quot;incidents&quot; than there are accidents and  we can learn much from these. </p>
	      <p>For example, a BC power  inflator may malfunction and cause the diver to ascend prematurely. This may  not cause harm but it is important to know when it occurs so that possible  faults and/or trends can be identified. </p>
	      <p>The DIMS is conducted by Dr.  Chris Acott and DAN Asia-Pacific encourages divers to participate in the study.</p>
	      <p><a href="../_pdf/dims_form.pdf">Click here to download a Standard DIMS Form</a></p>
	      <p><a href="../_pdf/dims_report.pdf">Click here to download the DIMS form for Technical and Cave Diving </a></p>
