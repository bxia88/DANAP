<?php $thisPage="ACCIDENT accident_reporting"; ?>
...
<title>DAN Divers Alert Network Asia-Pacific : Accident Reporting</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>Diving Accident Reporting</h1>
	      <p>As part of its mission to  improve dive safety, DAN collects and reports on diving fatalities and  injuries. 
	        To this end, DAN  Asia-Pacific is working to collect information concerning dive accidents and  incidents within the Asia-Pacific Region. </p>
	      <p>It is important that divers  assist us in this pursuit by notifying us of any dive incident or accident that  they become aware of in this Region. If you hear of a dive incident or  accident, we would be grateful if you would complete a brief report form and  send it to us. If you<a href="../contact.php"> send us an  email</a>   we will forward you the DAN Asia-Pacific Diving Incident Report Form.  Alternatively you can download the form below, complete it and send it back to  the DAN Head Office.</p>
	      <p><a href="../_pdf/accident_report_form.pdf">Click here to download the DAN Asia-Pacific Diving  Accident Report Form</a></p>
	      <p><strong>The following reports can be downloaded from DAN AP's Member-Only Portal by current Members. <a href="http://www.danasiapacific.org/main/member_only/index.php">CLICK HERE</a> to log in or <a href="http://www.danasiapacific.org/Membership_Insurance/residencycheck.php">CLICK HERE</a> to join DAN AP. </strong></p>
	      <ul>
	        <li><a href="../_pdf/accident_report_form.pdf"></a> DAN AP Report on Australian Diving Accidents 1999-2002 </li>
	        <li> 2006 Dive Accident Report from DAN America </li>
	        <li> 2007 Dive Accident Report from DAN America</li>
	        <li>2008 Dive Accident Report from DAN America</li>
          </ul>
	      <p><a href="research.php">Click here to read about DAN Research</a></p>
