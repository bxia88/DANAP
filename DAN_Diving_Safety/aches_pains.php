...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      ...
      <h1><strong>Aches and Pains  </strong></h1>
              ...
              <p><em>Answer provided by the DAN Medical Team    </em></p>
                        </p>
 	<!-- InstanceEndEditable --> 
	  	<div class="clear cx"><!-- --></div>
    </div>
