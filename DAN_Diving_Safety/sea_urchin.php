...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      ...
      <h1>Sea Urchin </h1>
              ...
              <p>I had  puncture wounds produced by spines of an unidentified sea urchin. Luckily, the  injury just caused swelling and redness, which led to just a little pain but no  infection. What is the right response after a sea urchin attack?</p>
              <h6>              DAN Answer:  </h6>
              <p>Injuries from sea urchin spines are common, but they do not attack. The diver  has to touch them. Commonly there will be a dozen or two puncture wounds after  contact with an urchin. The injuries can be very painful and can cause skin  infection but are not deadly. Some sea urchins have very long spines, which  tend to penetrate more deeply. The first lesson is prevention of injury. Be  aware that they are dangerous. They may be living in a hole in the reef so do  not put your hand where you cannot see. <br />
                <br />
