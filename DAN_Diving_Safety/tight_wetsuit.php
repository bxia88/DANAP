...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      ...
      <h1><strong>Tight Wetsuit </strong></h1>
		      <p align="justify"><em><strong>Diver Question: </strong></em></p>
	               
              <p><em>My wetsuit is very tight around the neck. Is  this a problem?</em></p>
              <h6><strong>DAN Answer </strong></h6>
              <p>A correctly fitting  wetsuit will fit snugly onto the skin to minimize ingress of water. But a  wetsuit can be too tight, and this can lead to problems. A wetsuit that is too  tight across your chest may impair your breathing, so this should be avoided.  If your suit is too tight around your neck and throat it can cause a problem  called carotid sinus syndrome. THIS IS A VERY DANGEROUS CONDTION!</p>
              <p>In your neck you have  carotid arteries, delivering vital blood supplies to your brain. Within the  carotid arteries are carotid sinuses, which detect changes in blood pressure.  If a rise in blood pressure is detected, the reflex can lower the blood  pressure and slow the heartbeat. 
                A tight neck seal can  press onto these carotid sinuses, and produce a false activation of the carotid  sinus reflex. The drop in blood pressure and slowed pulse will reduce blood  flow to the brain. The sufferer typically becomes weak, confused, dizzy and  even unconscious. 
                I have seen two divers  affected by carotid sinus syndrome. In both cases the victim was totally  incapacitated, and needed to be rescued by the dive partner.</p>
              <p>So if your neck seal is  uncomfortably tight, get it altered. </p>
              <p><em>Answer provided by  Stan Bugg, who is on the DAN AP Board of Directors.</em></p>
              <p>
                </p>
                        </p>
 	<!-- InstanceEndEditable --> 
