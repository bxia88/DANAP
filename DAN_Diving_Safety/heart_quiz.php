...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      ...
      <h1>Cardiovascular Health Quiz</h1>
	  <p align="center"><img src="../_images/heart_health.jpg" alt="DAN Safety Campaign" width="251" height="155" /></p>
		      
		      <p align="justify">Take our Four Question Cardiovascular Health Quiz and test  your knowledge on the likes of cardiovascular risk factors and cardiovascular events  that may endanger divers.</p>
		      <h6 align="justify"><a href="https://www.onlineexambuilder.com/cardiovascular-health/exam-38346">CLICK HERE</a> <br />
		        <br />
		        Learn more about Cardiovascular  Health issues by visiting <a href="DAN_Doc/cardiovascular.html">DAN Doc</a></h6>
		      <h5 align="justify">Not Yet a DAN Member? <a href="https://join.danap.org/">Join Today</a><br />
                              </h5>
		      </p>
 	<!-- InstanceEndEditable --> 
	  	<div class="clear cx"><!-- --></div>
