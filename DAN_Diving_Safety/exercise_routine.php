 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      ...
      <h1> Maintaining My Exercise Routine on Holiday </h1>
              ...
              <p align="justify">                Physical activity during the dive also has a direct impact on   decompression safety<em> (Reference 4,5,6,9)</em>. Exercise during the compression and bottom   phase increases inert gas uptake, effectively increasing the subsequent   decompression obligation of any exposure. It is important to remember   that dive tables and computers estimate inert gas uptake, they never   know reality. On the flip side, light exercise during the decompression   phase (including safety or decompression stops) increases inert gas   elimination and reduces risk. The caveat on exercise during   decompression is that more is not always better. Too much or too intense   exercise during the decompression phase can stimulate bubble formation,   thus inhibiting inert gas elimination and increasing decompression   risk. <br />
                ...
                <br />
                Finally, the post-dive period is a good time to take a nap or   relax over lunch. Both decompression and mental health can be helped by   an extended period of relaxation between the end of the dive and the   start of equipment shifting and/or racing on to the next activity. <br />
                <br />
                In summary, physical fitness - including both strength and   aerobic capacity - is important for divers both for physical safety and   decompression safety. Regular exercise training is best scheduled to   separate intense exercise and diving. Intense physical training should   be 24 hours on either side of diving activity. Any exercise within 24   hours of diving should involve the lowest possible joint forces. </p>
              <p><strong>References</strong> <br />
                <br />
                1. Broome JR, McNamee GA, Dutka AJ. Physical conditioning   reduces the incidence of neurological DCI in pigs. Undersea Hyperb Med.   1994; 21(suppl): 69.</p>
              <p> 2. Carturan D, Boussuges A, Burnet H, Fondarai J, Gardette   B. Circulating venous bubbles in recreational diving: relationships with   age, weight, maximal oxygen uptake and body fat percentage. Int J   Sports Med. 1999; 20(6): 410-414.</p>
              <p> 3. Dujic Z, Duplancic D, Marinovic-Terzic I, Bakovic D,   Ivancev V, Valic Z, Eterovic D, Petri NM, Wisloff U, Brubakk AO. Aerobic   exercise before diving reduces venous gas bubble formation in humans. J   Physiol. 2004; 555(3): 637-642.</p>
              <p> 4. Jankowski LW, Nishi RY, Eaton DJ, Griffin AP. Exercise   during decompression reduces the amount of venous gas emboli. Undersea   Hyperb Med. 1997; 24(2): 59-65.</p>
              <p> 5. Jankowski LW, Tikuisis P, Nishi RY. Exercise effects   during diving and decompression on postdive venous gas emboli. Aviat   Space Environ Med. 2004; 75(6): 489-495.</p>
              <p> 6. Jauchem JR. Effects of exercise on the incidence of   decompression sickness: a review of pertinent literature and current   concepts. Int Arch Occup Environ Health. 1988; 60(5): 313-319.</p>
              <p> 7. Pollock NW. Aerobic fitness and underwater diving. Diving Hyperb Med. 2007; 37(3): 118-124.</p>
              <p> 8. Powell MR. Exercise and physical fitness decrease gas   phase formation during hypobaric decompression. Undersea Biomed Res.   1991; 18(suppl): 61.</p>
              <p> 9. Van der Aue OE, Kellar RJ, Brinton ES. The effect of   exercise during decompression from increased barometric pressures on the   incidence of decompression sickness in man. US Navy Experimental Diving   Unit Research Report No. 8-49, 1949.</p>
              <p> 10. Wisloff U, Brubakk AO. Aerobic endurance training   reduces bubble formation and increases survival in rat exposed to   hyperbaric pressure. J Physiol. 2001; 537(Pt. 2): 607-611.
                </p>
                <br />
              </p>
      <!-- InstanceEndEditable --> 
