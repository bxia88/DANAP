<?php $thisPage="MEMBERSHIP osrescheck2"; ?>
<?php
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
		  <h1>Optional Dive Injury (Treatment) Insurance	      </h1>
		  <p class="box">If  you are living in Australia  you cannot sign-up via this link, as there are important Australian insurance  regulations that must be met. You must follow the correct link to satisfy these  requirements. <br />
If you are, in fact, living in Australia <a href="austrescheck2.php">CLICK HERE</a> otherwise continue  your application process.</p>
	      <p>Dive Injury  Insurance is an optional<strong> addition</strong> to your DAN Membership.</p>
	      <p>DAN  Membership includes Worldwide Emergency Evacuation but does <strong>not</strong> cover  treatment costs.</p>
	      <p>Adding on a level of  optional Dive Injury Insurance<em> (Standard, Master or Preferred Plan)</em> provides coverage for treatment and certain  other costs associated with covered dive accidents.</p>
	      <p><em>DAN AP's new <strong>Preferred Plus Plan</strong> extends beyond treatment for diving accidents and also provides coverage for Diving Vacation Interruption and Cancellation, Loss of Diving Equipment, Non-Diving Accident Medical Coverage for diving vacations, and more. </em></p>
	      <p><span class="sred">IMPORTANT:</span> Optional Dive Injury Insurance can only be purchased  <span class="emstrong">at the time of becoming </span>a<span class="emstrong"> <br />
	      </span> DAN Asia-Pacific Membership</p>
	      <h4>Do You Want To Add Optional Dive Injury (Treatment) Insurance To Your Membership?</h4>
	      <p>If you select  &ldquo;Yes&rdquo; each of the Dive Injury Insurance policies will be explained. You will  then be able to select the level of protection that meets your needs on the  application form. </p>
	      <div class="center"><table width="350" height="90" border="0">
            <tr>
              <td><div align="center"><a id="yes" href="osplans1.php">YES</a></div></td>
              <td><div align="center"><a href="#?w=500" rel="popup_no" id="no" class="poplight">NO</a></td>
            </tr>
          </table>
	        <p align="left"><strong>IMPORTANT NOTE:</strong></p>
	        <p align="left"><strong>Any signs or symptoms that appear within 24 to 48 hours of diving should be suspected of being diving-related.</strong><br />
