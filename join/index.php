<?php $thisPage="CONTACT internationaloffices"; ?>
...
<title>DAN Divers Alert Network Asia-Pacific : DAN Southern Africa</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
       <h1><em>Welcome to the Divers Alert Network (DAN) Asia-Pacific</em></h1>

        <h4>Did you know that emergency medical evacuations can cost more than $100,000?</h4>
        ...
        <p><a href="membership_insurance/residencycheck.php">Joining DAN</a> (Membership and Dive Injury Insurance) gives you peave of mind. It allows you to  enjoy your scuba diving knowing you will be looked after in the event of a diving incident, wherever you are in the world,  24-hours a day, 7 days a week.</p>
        ...
        <p id="btjoinnow" onMouseOver="self.status=document.referrer;return true" href="residencycheck.php"><a id="btjoinnow" href="membership_insurance/residencycheck.php" onMouseOver="self.status=document.referrer;return true">BACK</a>

        <a id="back" href="residencycheck.php">JOIN DAN NOW</a></p>
