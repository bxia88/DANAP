...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
        <div id="content">
		  ...
		  <h4>PLEASE NOTE</h4>
		  <p><em>The prices provided for all products in the DAN AP range are Member Only prices. This price is exclusive of freight and GST (within Australia only).
	      Visit Membership &amp; Insurance should you wish to become a DAN Asia-Pacific Member and be eligible to receive Member prices</em>.</p>
		  <div id="catimage">
		  <table width="95%">
            <tr>
              <td>		
