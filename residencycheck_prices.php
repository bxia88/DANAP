<?php $thisPage="MEMBERSHIP residencycheck_prices"; ?>
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <div class="center"><h1>Are You Living In Australia?</h1></div>
		            <div class="center"><span class="emred">Please select either Yes or No depending on where you reside within the Asia-Pacific Region.</span></div>
          <div class="center yesno">
		    <table width="350" height="90" border="0">
            <tr>
              <td><div align="center"><a id="yes" href="../Membership_Insurance/austprices.php">YES</a></div></td>
              <td><div align="center"><a id="no" href="../Membership_Insurance/osprices.php">NO</a></div></td>
            </tr>
          </table></div>
