...
<title>DAN Divers Alert Network Asia-Pacific : DAN America</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
       ...
       <p>DAN America serves as the headquarters for IDAN. </p>
       
       <h5>DAN America coverage includes:</h5>
       <ul>
       ...
       <h5>Contact Details</h5>    
    	Emergency Hotline Number: +1-919-684-9111
    	<br/><br/>
    	Website: <a href='http://www.diversalertnetwork.org' alt='DAN America'>www.diversalertnetwork.org</a>
    	<br/><br/>
    	
    	 <h1>DAN Brazil</h1>
       
       <h5>DAN Brazil coverage includes:</h5>
       <ul>
       	<li>Brazil</li>
       	</ul>
       ...
       <h5>Contact Details</h5>    
    	Emergency Hotline Number: +1-919-684-9111
    	<br/><br/>
    	Website: <a href='http://www.danbrasil.org.br/' alt='DAN Brasil'>www.danbrasil.org.br</a>
       <br/><br/>
    	
    	 <h1>DAN World</h1>
       
       <h5>DAN World coverage includes:</h5>
       <ul>
       	<li>The Caribbean</li>
       	<li>Polynesia</li>
       	<li>Micronesia and Melanesia (except Fiji)</li>
       	<li>Puerto Rico</li>
       	<li>Guam</li>
       	<li>Bahamas</li>
       	<li>Bristish and U.S Virgin Islands</li>	
       ...
       <h5>Contact Details</h5>    
    	Emergency Hotline Number: +1-919-684-9111
    	<br/><br/>
    	Website: <a href='https://www.diversalertnetwork.org/world' alt='DAN World'>www.diversalertnetwork.org/world</a>
