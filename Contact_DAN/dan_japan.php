...
<title>DAN Divers Alert Network Asia-Pacific : DAN Japan</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
       ...
       <h5>DAN Japan coverage includes:</h5>
       <ul>
       	<li>Japan</li>
       	<li>Japanese islands and related territories</li>
       	<li>with regional IDAN responsibility for Northeast Asia-Pacific</li>
       	
       	</ul>
       	
       <h5>Contact Details</h5>    
    	Emergency Hotline Number:  +81-3-3812-4999
    	<br/><br/>
    	Website: <a href='http://www.danjapan.gr.jp/' alt='DAN America'>www.danjapan.gr.jp</a>
