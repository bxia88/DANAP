<?php $thisPage="CONTACT asiapacificoffices"; ?>
...
<title>DAN Divers Alert Network Asia-Pacific - Scott Jamieson</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
    ...
    <div id="body_content">
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      <div id="content">
          <p align="left"><img src="../_images/DANLogo.jpg" width="400" height="104" border="0" /></a></p>
          <h1>Scott Jamieson, General Manager </h1>  
          <h1>Divers Alert Network Asia-Pacific </h1>
          <h3><a href="mailto:scottj@danap.org">scottj@danap.org</a></h3>
          <h3>T: +61-3-9886 9166</h3>
          <h3>Skype: scottj.danap</h3>
          <h3><a href="http://www.danap.org">www.danap.org</a></h3>
          <h3>49A Karnak Road (PO Box 384), Ashburton, Victoria, 3147, Australia</h3>
		  <p>&nbsp</p>
		  <p>Download .vcf (Digital Business Card) <a href="scott.vcf">here</a></p>
        </div>
	    <!-- InstanceEndEditable --> 
