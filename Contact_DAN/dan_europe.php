...
<title>DAN Divers Alert Network Asia-Pacific : DAN Europe</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      <div id="content">
       ...
       <h5>DAN Europe coverage includes:</h5>
       <ul>
       	<li>Geographical Europe</li>
       	<li>The countries of the Mediterranean Basin</li>
       	<li>The countries on the shores of the Red Sea</li>
       	<li>The Middle East including the Persian Gulf</li>
       	<li>The countries on the shores of the Indian Ocean north of the equator and west of India and Sri Lanka</li>
       	<li>as well as the related overseas territories, districts and protectorates</li>
       	
       	</ul>
       	
       <h5>Contact Details</h5>    
    	<p>Emergency Hotline Number: *3906-4211 5685 <br/>
    	  <br/>
    	Website: <a href='http://www.daneurope.org/' alt='DAN America'>www.daneurope.org</a>
