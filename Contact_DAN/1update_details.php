<?php $thisPage="CONTACT update_details"; ?>
...
<title>DAN Divers Alert Network Asia Pacific: Update Your Contact Details</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
	      ...
	      <p>If any of your  contact details have changed since you applied for DAN Membership it is  important that you notify the DAN Team of any changes.&nbsp; All you need to do is complete the below form  and submit to DAN for processing.</p>
		  
		 <div id="form"><? include('http://www.danasiapacific.org/main/_danforms/form.php?form_id=2') ?> </div>
		 <p></p> 
		 <p></p> 
