...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
       <h1>DAN Southern Africa</h1>

       
       <h5>DAN Southern Africa coverage includes:</h5>
       <ul>
       	<li>South Africa</li>
       	<li>Swaziland</li>
       <li>Lesotho</li>
       ...
       <h5>Contact Details</h5>    
    	Emergency Hotline Number:  +27-10-209-8112
    	<br/><br/>
    	Website: <a href='http://www.dansa.org/' alt='DAN America'>http://www.dansa.org</a>
