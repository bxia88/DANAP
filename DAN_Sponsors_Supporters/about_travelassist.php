<?php $thisPage="SPONSORS about_travelassist"; ?>
<?php
...
<title>DAN Divers Alert Network Asia-Pacific : TravelAssist Emergency Evacuation Coverage </title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
         <h1><em>TravelAssist </em>Emergency Evacuation Coverage</h1>
		 
		 <h3><a href="file:///I|/Documents/DAN WEB/Current Web/main/sponsors/about_travelassist.php"></a><strong>	      IMPORTANT INFORMATION </strong></h3>
		 <ol>
           <li>The diver must  be travelling more than 80km* from their residential address before the  emergency medical evacuation benefit commences. </li>
		   <li>DAN <em>TravelAssist</em> MUST arrange all evacuations if they are to  be paid for by DAN <em>TravelAssist</em>.</li>
	      </ol>
		 <p><em>Note: The 80km restirction rule in waived in the event of a diving accident / illness only, where a Member has elected to add a level of optional Dive Injury Insurance to their Membership.</em><br />
             <br />
		   The determination of the need for an  emergency evacuation or medical repatriation will be made by DAN <em>TravelAssist</em> in consultation with a local attending physician and payment will be made  direct to the evacuation provider by DAN<em> TravelAssist</em>. The divers membership  card contains the hotline numbers and the DAN <em>TravelAssist</em> number. These  numbers are also available in the <a href="../emergency/hotline_numbers.php">Emergency Procedures</a> section on the DAN AP website. </p>
		 <h2><strong>What Are the Other Benefits of DAN&rsquo;s <em>TravelAssist</em>? </strong> </h2>
		 <p>In addition to evacuation coverage,  DAN&rsquo;s <em>TravelAssist</em> includes a variety of other benefits, such as: return of a  travel companion and/or dependent children; the visit of a family member or  friend; emergency cash advance; legal assistance; and more. <a href="../Membership_Insurance/travelassist.php">CLICK HERE</a> for more information. </p>
		 <p><a id="back" href="javascript:history.go(-1)" onMouseOver="self.status=document.referrer;return true">ACK</a>	    </p>
		 <p align="justify">
          
          <ul>
            <div align="center"><img src="../_images/DAN_logo.jpg" alt="Mike Ball" width="220" height="90" class="imgCentre" />
            </div>
          </ul>
	      <p>&nbsp;</p>
        </div>
