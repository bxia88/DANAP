<?php $thisPage="SPONSORS commonly_asked_questions"; ?>
<?php
...
<title>DAN Divers Alert Network Asia-Pacific : Commonly Asked Questions </title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
		 ...
		 <h2><strong>Do Divers Need to Take out DAN Membership &amp; Dive Injury  Insurance? </strong> </h2>
		 <p>Divers can take out DAN Membership only, however, they cannot take out Treatment  Insurance without DAN Membership. </p>
		 <p>So DAN Membership is compulsory whilst Dive  Injury (Treatment) Insurance is optional. </p>
		 <h2><strong>Does DAN Offer &ldquo;Umbrella&rdquo; Coverage?</strong></h2>
		 <p>DAN Asia-Pacific does not offer an umbrella coverage. DAN Membership &amp;  optional Dive Injury Treatment Insurance have been created to meet the  individual needs of divers. As such each diver and staff needs to apply for DAN coverage individually.</p>
		 <p align="justify">
