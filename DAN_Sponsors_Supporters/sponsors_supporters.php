...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      ...
      <h1>DAN Sponsors &amp; Supporters  </h1>
          <h2>DAN Sponsors</h2>
          <p><em>DAN Sponsors are dive businesses, corporations, organisations and enthusiasts who believe in and promote DAN. Supporters financially sponsor the organisation to enable DAN to continue in its mission of striving to enhance the safety of diving in the recreational diving community. </em></p>
          <p><a href="gold.php">CLICK HERE</a> to view DAN Asia-Pacific's Gold Sponsors</p>
          <p><a href="platinum.php">CLICK HERE</a> to view DAN Asia-Pacific's Platinum &amp; Platinum Plus Sponsors </p>
          <p>&nbsp;</p>
          <h2>DAN Supporters </h2>
          <p><em>DAN Supporters are dive operators who are advocates for dive safety and want to actively communicate the dive safety message with their divers. These businesses display promotional materials and generally assist in spreading the dive safety message and actively encourage their divers to  &quot;be prepared&quot; by being a DAN AP Member. </em></p>
          <p><a href="dan-supporters.php">CLICK HERE</a> to view DAN Asia-Pacific's Supporters </p>
          <p>&nbsp;</p>
          <h2>Friends of DAN Asia-Pacific</h2>
          <p>In addition to our Sponsors and Supporters, there are other organisations within the community that support DAN and are keen to promote the importance of our work and the benefits of dive safety. <br />
          Follow the link below to view these organisations.</p>
          <p><a href="supporting.php">CLICK HERE </a> to view the Friends of DAN AP</p>
