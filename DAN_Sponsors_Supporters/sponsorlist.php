<?php $thisPage="SPONSORS sponsorlist"; ?>
<?php
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>The Who's Who of DAN Sponsors</h1>
	      <p>Follow the links below for a  list of Sponsors who have kindly donated funds to the Divers Alert Network in  recognition of our contribution to dive safety and our ongoing work to make  diving safer and more enjoyable.&nbsp; DAN  Asia-Pacific is very grateful to these Sponsors. </p>
	      <h3 class="box"><a href="platinum.php">Click here to view our Platinum Sponsors</a></h3>
	      <h3 class="box"><a href="gold.php">Click here to view our Gold Sponsors</a></h3>
