<?php $thisPage="SPONSORS supporting"; ?>
<?php
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
        <h1>Friends of DAN Asia-Pacific</h1>
            <div class="centre" id="tb">
              <table width="98%">
                <tfoot>
                </tfoot>
                <tbody>
                  <tr >
                    <td><h4>Scuba Dive New Zealand</h4>
                      <p><a href="http://www.scubadive.net.nz/">www.scubadive.net.nz</a></p>                    </td>
                  </tr>
                  <tr class="odd" >
                    <td><h4>Cave Divers Association of Australia  </h4>
                    <p><a href="http://www.cavedivers.com.au">www.cavedivers.com.au</a></p></td>
                  </tr>
                  <tr >
                    <td><h4>Auckland University Underwater Club </h4>
                      <p><a href="http://www.akunidive.com">www.akunidive.com</a></p>                    </td>
                  </tr>
				  <tr class="odd" >
				    <td><h4>Tourism Queensland</h4>
                      <p><a href="http://www.queenslandholidays.com.au/dive-queensland/">www.divingqueensland.com.au</a></p>                    </td>
                  </tr>
				    <tr class="odd" >
				  <td><h4>Australian Underwater Federation Qld Inc. </h4>
                      <p><a href="http://www.aufq.org.au">www.aufq.org.au</a></p>                    </td>
					   </tr>
					  <tr >
                    <td><h4>Dive &amp; Discovery</h4>
                      <p><a href="http://www.diveanddiscovery.com">www.diveanddiscovery.com</a></td>
                  </tr>
				   <tr class="odd" >
                    <td><h4>SoundFactor Asia Ltd &nbsp;Hong Kong</h4>
                      <em>Rick Boughton and Jenny Zhang                      </em>
                      <p><em>Phone: +852 94621 791 &nbsp;</em><br />
                          <a href="http://www.gzsoundfactor.com">www.gzsoundfactor.com</a><a href="http://www.cavedivers.com.au"><br />
                      </a></p>
                     </td>
                  </tr>
                </tbody>
              </table>
            </div><a id="back" href="javascript:history.go(-1)" onMouseOver="self.status=document.referrer;return true">BACK</a>
        </div>
	    <!-- InstanceEndEditable --> 
	  	<div class="clear cx"><!-- --></div>
    </div>
