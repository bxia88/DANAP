<?php $thisPage="TRAINING oxygen_prov_firstaid"; ?>
<?php
...
<title>DAN Divers Alert Network Asia-Pacific : Oxygen Provision</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>Course in Basic Oxygen Administration - 22298VICVIC </h1>
	      <img src="../_images/o2GenIcon.jpg" width="90" height="84" class="imgRight" />
	      <p><span class="subHeading">(Nationally Recognised in Australia - RTO 4659)</span></p>
	      <p></em>Participants must be 14 years or older. In addition, in Australia,  participants must have completed the Course in Cardiopulmonary Resuscitation,  hold an equivalent and current CPR certificate, or must have been assessed as  &ldquo;Competent&rdquo; in CPR by the DAN Instructor. </p>
	      <p>Topics  covered include illness or injury recognition, the benefits of oxygen  provision, precautions and safety procedures, and oxygen provision to both  responsive and unresponsive victims. Participants are certified in the use of  the particular oxygen unit (or an equivalent system) on which the training was  conducted.</p>
	      <p><img src="../_images/oxy_prov_gen_fa_pack.jpg " width="192" height="168" class="imgRight" /></p>
	      ...
	      <p>Satisfactory completion of the Oxygen Provider Unit of Competency is required  prior to receiving the <span class="strong">DAN Course in Basic Oxygen Administration </span>qualification <em>without a CPR endorsement</em>. Satisfactory completion of both  the Course in Cardiopulmonary Resuscitation and the Oxygen Provider Unit of  Competency is required prior to receiving the <span class="strong">Course in Basic Oxygen Administration </span>qualification, which would also be <span class="em">endorsed for CPR</span>.</p>
	      <p><a href="course_info/22298boa_201601.pdf">Download Course Information Sheet</a></p>
	      <p><a href="mailto:training@danap.org">Contact DAN Asia-Pacific to locate a DAN-certified Trainer near you</a></p>
		  <a id="back" href="javascript:history.go(-1)" onMouseOver="self.status=document.referrer;return true">BACK</a>
	      <p> <a href="nationallyrecognisedcourses.php">Return to DAN Nationally Recognised Training</a></p>
	    </div>
	    <!-- InstanceEndEditable --> 
	  	<div class="clear cx"><!-- --></div>
    </div>
