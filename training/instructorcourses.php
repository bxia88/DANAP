<?php $thisPage="TRAINING instructorcourses"; ?>
<?php
...
<title>DAN Divers Alert Network Asia-Pacific : Instructor Courses</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>DAN Instructor Courses</h1>
	      <p>DAN Asia-Pacific offers a comprehensive training program to enable our Instructors to confidently teach the range of DAN Asia-Pacific programs.   </p>
	      <p>Follow the links below to find out more about our Instructor Courses. </p><img src="../_images/external_pic009.jpg" class="imgRight" />
	      <ul>
	        <li><a href="first_aid_instructor.php">DAN First Aid Instructor Training</a></li>
	        <li><a href="oxygen_instructor.php">DAN Oxygen Instructor Training</a></li>
	        <li><a href="other_instructor.php">Other DAN Instructor Training</a></li>
          </ul>
	      <p>&nbsp;</p>
	      <p>&nbsp;</p>
	      <p>&nbsp;</p>
