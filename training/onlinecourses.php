<?php $thisPage="TRAINING onlinecourses"; ?>
<?php
...
<title>DAN Divers Alert Network Asia-Pacific : Online Training</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>DAN Online Courses</h1>
          <p class="subHeading">JavaScript must be enabled for these courses</p>
          <h2>Apply First Aid Online</h2>
		  <p><strong>For  the online First Aid learning module</strong> <br>
	      <a href="javascript:openWBT(58);">Click here to continue on to the DAN Asia-Pacific Apply First Aid Online</a></p> <p>&nbsp;</p>
	      <p>&nbsp;</p>
	      <p>&nbsp;</p>
          <h2>Instructor Orientation Online </h2>
          <p><a href="javascript:openWBT(13);">DAN Asia-Pacific Instructor Transfer Requirements and Online Orientation.</a></p>
          <p>&nbsp;</p>
	      <p>&nbsp;</p>
	      <p>&nbsp;</p>
	      <p>&nbsp;</p>
