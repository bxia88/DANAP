<?php $thisPage="TRAINING first_aid_instructor"; ?>
<?php
...
<title>DAN Divers Alert Network Asia-Pacific : First Aid Instructor</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>DAN First Aid Instructor</h1><img src="../_images/FAIcon.jpg" width="90" height="84" class="imgRight" />
	      <p>DAN Asia-Pacific offers a comprehensive training program  to enable its Instructors to confidently teach the DAN First Aid programs.</p>
	      <p> The DAN AP First Aid Instructor course is run over two days and is designed to  both test and expand the candidate's knowledge of first aid theory as well as  enhance their practical skills to Instructor level.</p>
	      <p>The course consists of various modules some of  which are presented by the trainees and others that are presented by the  trainer. In addition to these theory sessions there are also practical sessions  to assess competence in resuscitation, bandaging and scenario management skills. </p>
	      <img src="../_images/first_aid_instructor_pack.jpg" width="250" height="201" class="imgRight" />
	      <p>Candidates must satisfactorily complete both the theory and practical components prior to being certified as a DAN Asia-Pacific First Aid Instructor.</p>
	      <p><a href="mailto:training@danap.org">Contact DAN Asia-Pacific to locate a DAN Certified Trainer near you.</a></p>
	      <p><a href="instructorcourses.php">Return to DAN Instructor Courses</a></p>
	      <p><img src="../_images/shop/s_emergency_care_book.jpg" alt="Emergency Care Book" width="135" height="160" class="imgLeft" /></p>
	      <p>&nbsp;</p>
	      <p>&nbsp;</p>
	      <p>&nbsp;</p>
	      <p>&nbsp;</p>
	      <p><a id="back" href="javascript:history.go(-1)" onMouseOver="self.status=document.referrer;return true">BACK</a>
            </p>
	    </div>
	    <!-- InstanceEndEditable --> 
	  	<div class="clear cx"><!-- --></div>
