<?php $thisPage="TRAINING haz_marine_life"; ?>
<?php
...
<title>DAN Divers Alert Network Asia-Pacific : Hazardous Marine Life</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content"><img src="../_images/HMLIcon.jpg" width="90" 	height="84" class="imgRight" />
          <h1>DAN First Aid for Hazardous Marine Life Injuries</h1>
          <p><span class="subHeading">(Please note this is not a Nationally Recognised Course)</span></p>          
          
          <p>This very interesting four-hour program deals with the  recognition, first aid, and importantly, prevention of injuries or illness from  a variety of potentially hazardous marine life. </p>
          <img src="../_images/hmli_book.jpg" width="118" height="149" class="imgLeft" /><p>Topics covered include jellyfish, fish with  venomous spines, blue-ringed octopus, sea snakes, fish poisonings and many  more. The theory and video presentations are supported by practical; exercises  in bandaging, bleeding control, pressure-immobilisation technique and revision  of CPR. Optional additions include oxygen supplemenation and the use of  Automated External Defibrillators (AEDs). </p>
          <img src="../_images/jellyfish.jpg" width="132" height="178" class="imgRight" />
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p><a href="mailto:training@danap.org">Contact DAN Asia-Pacific to locate a DAN-Certified Trainer near you</a></p>
          <p><a href="otherdancourses.php">Return to Other DAN Courses</a></p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
