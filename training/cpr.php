...
<title>DAN Divers Alert Network Asia-Pacific : CPR</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>Provide Cardiopulmonary Resuscitation - HLTAID001</h1>
          <p class="subHeading">(Nationally Recognised in Australia - RTO 4659)
          <img src="../_images/CPRicon.jpg" width="90" height="84" class="imgRight" />          </p>
          <p><br />
          This course, with a nominal duration of 4 hours, is designed  to provide participants with training in techniques for basic life support,  including the management of an unresponsive victim and cardiopulmonary  resuscitation (CPR).</p>
          <img src="../_images/cpr_book.jpg" width="143" height="192" class="imgLeft" /><p> Participants must have basic English-speaking skills and reading skills unless  training materials are provided in the appropriate non-English language. They  must also have the strength to manage CPR and other emergency situations. </p>
          <p> After the competent completion of all of the required skills, you will receive a Statement of Attainment from DAN when the registration procedures have been completed. The program is accredited by State and National government  recognition authorities under National Training Recognition Scheme.</p><img src="../_images/firstaid_pic004.jpg" width="224" height="209" class="imgRight" />
          
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p><a href="course_info/HLTAID001.pdf">Download Course Information Sheet</a></p>
