...
<title>DAN Divers Alert Network Asia-Pacific : Instructor Training</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>DAN Asia-Pacific Instructor Training</h1>
	      <p>DAN Asia-Pacific offers Instructor training for the entire  range of DAN Programs. This training is offered by DAN Asia-Pacific Instructor  Trainers at our training facility in Ashburton,   Victoria, Australia  as well as at various locations throughout the entire AP region. If you are  interested in DAN Instructor level training. You should contact <a href="mailto:training@danap.org">DAN AP&rsquo;s Training Department</a>  for details of an Instructor Trainer near you or you can check the <a href="inhouse.php">schedule of in house courses</a> for details of courses  being run at our head office.</p>
	      <div class="imageCenter"><img src="../_images/seminar_15.jpg" width="220" height="170" class="imgCenter" /></div>
