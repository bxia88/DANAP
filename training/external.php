<?php $thisPage="TRAINING external"; ?>
...
<title>DAN Divers Alert Network Asia-Pacific : External Training</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>Divers Alert Network : Asia-Pacific Trainers</h1>
	      <p>DAN Asia-Pacific has a number of Instructors  conducting courses all over the  Asia-Pacific Region at any given  time. For information on instructors who may be able to offer training in your area please contact DAN Training (<a href="mailto:training@danap.org">training@danap.org</a>). </p>
	      <h2>&nbsp;</h2>
         </li>
		   </ul>
		   <p class="emstrong">&nbsp;</p>
