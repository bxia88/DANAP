<?php $thisPage="TRAINING occupational_first_aid"; ?>
<?php
...
<title>DAN Divers Alert Network Asia-Pacific : Advanced First Aid</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>Provide Advanced First Aid - HLTAID006</h1>
	      ...
	      <p>This program is designed to provide participants with training in basic life support and in the first aid management, recording and reporting of the more common and/or more serious injuries or illnesses that may be encountered within the the workplace as well as some of the special considerations when dealing with hazardous substances, medications, oxygen provision, use of AEDs and first aid in confined spaces.</p><img src="../_images/external_pic005.jpg" width="168" height="120" class="imgLeft" />
          
	      <p>It deals with specific workplace issues, legal issues, recording and reporting. You will participate in both theory and practical sessions, which will be followed by a skills assessment and theory knowledge tests.  After the competent completion of all of the required skills, you will receive a Statement of Attainment from DAN when the registration procedures have been completed. </p><img src="../_images/general_aquatic_kit.jpg" width="140" height="200" class="imgRight" />
		  <p>&nbsp;</p>
	 	  <p>&nbsp;</p>
	      <p><a href="course_info/HLTAID006.pdf">Download Course Information Sheet</a></p>
