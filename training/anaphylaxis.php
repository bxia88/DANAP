...
<title>DAN Divers Alert Network Asia-Pacific : Anaphylaxis</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>Course in First Aid Management of Anaphylaxis 22300VIC </h1>
          <p class="subHeading">(Nationally Recognised in Australia - RTO 4659)</p>
          <img src="../_images/AnaIcon.jpg" width="90" height="84" class="imgRight" />
	      <p>There is an increasing prevalence of allergic disease in the Western world and approximately 1 in 3 people will suffer from some form of allergic disease in their lifetime. This program will teach the participant how to manage and to prevent severe allergic reactions and anaphylaxis as wll as how to prepare management plans and to prepare for anaphylactic emergencies. </p>
	   
	   
	      <p><a href="mailto:training@danap.org">Contact DAN Asia-Pacific to locate a DAN-Certified Trainer near you</a></p>
	      <p><a href="course_info/22300ana_201601.pdf">Download a course information sheet </a></p>
