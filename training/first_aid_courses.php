<?php $thisPage="TRAINING first_aid_courses"; ?>
<?php
...
<title>DAN Divers Alert Network Asia-Pacific : First Aid Courses</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>DAN Asia-Pacific Courses in First Aid</h1><img src="../_images/FAIcon.jpg" width="90" height="84" class="imgRight" />
	      <p>DAN Asia-Pacific, in addition to a comprehensive range of Oxygen courses, also offers a full range of First Aid Programs, which are Nationally Recognised (in Australia) as well as being regarded highly in other parts of the world.  These courses include: </p>
	      <ul>
	        <li><a href="cpr.php">Provide Cardioplumonary Resuscitation</a></li>
            <li><a href="els.php">Provide Basic  Emergency Life Support</a> </li>
            <li><a href="Provide_first_aid.php">Provide First Aid</a></li>
            <li><a href="edu_first_aid.php">Provide an Emergency FIrst Aid Response in an Education and Care Setting</a></li>
            <li><a href="advanced_first_aid.php">Provide Advanced First Aid</a></li>
            <li><a href="advanced_resus.php">Provide Advanced Resuscitation  </a></li>
	      </ul>
          <p>For more details about these courses click on the links above or <a href="mailto:training@danap.org">contact DAN Training</a> by email.</p>
          <p><strong>Divers Alert Network (DAN) Asia-Pacific Ltd Registered Training Organisation 4659. <br />
          <br />
          </strong><img src="../_images/firstaid_pic004.JPG" width="224" height="209" class="imgLeft" />          </p>
          <p><a href="nationallyrecognisedcourses.php"></a> </p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
