<?php $thisPage="TRAINING Advanced_Resuscitation"; ?>
<?php
...
<title>DAN Divers Alert Network Asia-Pacific : Advanced Resuscitation</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>Provide Advanced Resuscitation  - HLTAID007</h1>
	      ...
	      <p>This unit deals with the provision of advanced first aid resuscitation techniques, life support and management of casualty(s) until the arrival of medical or other assistance, and provision of support to other providers. </p>
	      <p><img src="../_images/external_pic005.jpg" width="180" height="120" class="imgLeft" />	      </p>
	      <p>You will be trained in advanced resuscitation techniques including airway management using oropharyngeal airway and the use of suction, Oxygen administration to the breathing casualty using the appropriate delivery devices, oxygen resuscitation using manually triggered resuscitators and bag valve masks as well as use of an AED. </p>
	      <img src="../_images/general_aquatic_kit.jpg" width="140" height="200" class="imgRight" />
	      <p></p>
	      <p>&nbsp;</p>
	      <p><a href="course_info/HLTAID007.pdf">Download Course Information Sheet</a></p>
