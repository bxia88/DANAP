...
<title>DAN Divers Alert Network Asia-Pacific : Courses</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>DAN Asia-Pacific Courses</h1>
	      <p>DAN Asia-Pacific offers a  broad scope of courses that range from Nationally Recognised,  Online as well  as courses for Instructors.&nbsp; Follow the  below links to discover more about the courses on offer in each category.</p>
	      <ul>
	        <li><a href="nationallyrecognisedcourses.php">Nationally Recognised Courses</a></li>
            <li><a href="otherdancourses.php">Other DAN Courses (Not Nationally Recognised)</a></li>
	        <li><a href="onlinecourses.php">Online Courses</a></li>
	        <li><a href="instructorcourses.php">Instructor Courses</a></li>
          </ul>
	      <p> <span class="strong">Note</span>: Javascript only needs to be enabled for online courses</p>
	      <p>&nbsp;</p>
	      <p><a href="../training.php"></a><img src="../_images/external_pic006.jpg" alt="External Pic" width="220" height="170" class="imgRight_10" />
