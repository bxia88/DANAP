<?php $thisPage="TRAINING senior_first_aid"; ?>
<?php
...
<title>DAN Divers Alert Network Asia-Pacific : First Aid</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>Provide an emergency first aid response in and education and care Setting (HLTAID004)</h1>
		  <p class="subHeading">(Nationally Recognised in Australia - RTO 4659)</p>
		  <img src="../_images/FAIcon.jpg" width="90" height="84" class="imgRight" />
	      <p>The purpose of this program (nominal duration of 20 hrs) is  to provide participants with training in basic life support and in the first  aid management of the more common and/or more serious injuries or illnesses  that may be encountered within the Education and Care Setting. It focuses particularly on managing conditions occurring in children and infants.</p>
	      <p> You will be trained in first aid procedures that should enable you to assist an  injured or ill person until medical aid is accessed. Topics include: management  of the unresponsive victim, resuscitation, bleeding, respiratory emergencies,  cardiac emergencies, fractures, soft tissue injuries, head injuries, asthma and anaphyaxis, diabetes,  epilepsy/convulsions, envenomation, poisoning, and thermal injuries. You will  participate in both theory and practical sessions, which will be followed by a  skills assessment and multiple-choice theory knowledge test. </p><img src="../_images/senior_first_aid_pack.jpg" width="260" height="214" class="imgRight" />
	      <p> After the competent completion of all of the required  skills, you will receive a Statement of Attainment from DAN when the  registration procedures have been completed. The program is accredited by State  and National government recognition authorities under National Training Recognition  Scheme.</p>
	      <ul>
	        <li>
	          <div align="left"><a href="course_info/HLTAID004.pdf">Download Course Information Sheet</a></div>
	        </li>
	        <li>
	          <div align="left"><a href="mailto:training@danap.org">Contact DAN Asia-Pacific to locate a DAN-Certified Trainer near you</a></div>
	        </li>
	        <li>
	          <div align="left"><a href="first_aid_courses.php">Return to DAN First Aid Courses</a></div>
	        </li>
          </ul>	
	      <p>&nbsp;</p>
