...
<title>DAN Divers Alert Network Asia-Pacific : AED</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>Operate an Automated External Defibrillator in an Emergency - PUAOPE010C</h1>
          <p class="subHeading">(Nationally Recognised in Australia - RTO 4659)</p>
          <p><img src="../_images/AEDIcon.jpg" width="90" 
	height="84" class="imgRight" />Heart attack is a very common cause of death. A severe heart attack often results in cardiac arrest. In this case, the heart usually beats very erratically and cannot generate circulation of blood to the body. If a normal heartbeat is not restored within a few minutes, the victim will die.</p>
          <p><img src="../_images/aed_book.jpg" class="imgLeft" />Automated external defibrillators (AEDs) are designed to diagnose cardiac arrest and, when appropriate, to deliver an electric shock to try to restore a normal heart rhythm. They can be used by people with minimal training. </p>
          <p>DAN Asia-Pacific has introduced a 4-hour program to train laypersons in the use of AEDs. This is not just an orientation but a thorough and responsible certification program </p><img src="../_images/defib_pic002.jpg" width="125" height="183" class="imgRight" />
          <p>The pre-requisite is a CPR certification. If this is required, it can also be done as an additional module prior to the AED course</p>
          <p><a href="course_info/puaope010c_aed_240112.pdf">Download Course Information Sheet</a></p>
	      <p><a href="mailto:training@danap.org">Contact DAN Asia-Pacific to locate a DAN-Certified Trainer near you</a></p>
	      <p><a href="first_aid_courses.php">Return to DAN First Aid Courses</a></p>
	      <p>&nbsp;</p>
	      <p>&nbsp;</p>
