...
<title>DAN Divers Alert Network Asia-Pacific  : Alert Diver Sample</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      <div id="content">
        <h1>DAN AP TShirt Promotion: Conditions </h1>
        <ul type="disc">
          <li>The Promotion is valid only for New DAN       AP Members and Expired DAN AP Members. Current Members are unable to       participate in the promotion. </li>
        ...
        <p align="center"><a href="http://issuu.com/dan-alertdiver/docs/alertdiver__q4_2015"><img src="_images/adex_tshirt.jpg" width="443" height="382" border="0" /></a></p>
        <h1><strong>How to  Redeem DAN AP's Free T-Shirt Offer</strong></h1>
        <p><strong>STEP 1: </strong><strong><a href="https://join.danap.org/" target="_blank" title="JOIN DAN FOR TSHIRT OFFER">CLICK  HERE </a></strong> to join DAN  Asia-Pacific. You must enter &quot;ADEX&quot; in the Referral Field on the  second screen of the form.<br />
          <br />
