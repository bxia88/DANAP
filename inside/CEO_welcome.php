...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>From the CEO</h1>
          <p>Dear Fellow Divers,<img src="../_images/chris_wachholz.jpg" alt="DAN Asia-Pacific Director" width="120" height="150" class="imgRight_10" /></p>
	      <p>If you are reading this I am  guessing  you love scuba diving. Maybe you are a diving professional or  have dreams of making a career out of your passion for the life aquatic. Or 
perhaps you just enjoy the beauty  and serenity of a coral reef. As someone who likewise cares deeply about  diving, it is my great honour to succeed John Lippmann, the founder of Divers  Alert Network (DAN) Asia-Pacific (AP) as its new CEO. The dive industry and  public has been blessed with John&rsquo;s extraordinary accomplishment in laying the foundation  for the important emergency and safety services DAN provides.</p>
	      <p>To help diving grow, and keep it  safe, DAN plans to invest substantially in many more Asia-Pacific countries and  languages. Our goals are to:<br />
            <br />
	        1. Expand the dive emergency  hotlines for advice and treatment.<br />
	        2. Provide multilingual emergency  services and safety information.<br />
	        3. Collect and publish more dive  accident data.<br />
	        4. Increase dive medical assessment  skills of local clinics and improve their oxygen first aid capabilities, as  well as those of local dive operators.<br />
            <br />
	        YOU, the diver, are the key to the  future of diving throughout the Asia-Pacific. You are key because none of the  above critical, essential, must-do objectives can happen unless you and more of  your fellow dive friends join and renew as members of DAN. Together we can  speak to the importance of dive safety, and be there for you when you need us.<br />
            <br />
            <em>Love  diving? Tell your friends, <a href="../membership/residencycheck.php">join today</a>.</em></p>
	      <p>	        Safe diving,<br />
	        Chris Wachholz,<br />
            <em>CEO, DAN Asia-Pacific</em><strong></strong></p>
	    </div>
	    <!-- InstanceEndEditable --> 
	  	<div class="clear cx"><!-- --></div>
    </div>
