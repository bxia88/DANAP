...
<title>DAN Divers Alert Network Asia-Pacific : Mission Statement</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
          <h1>DAN Mission</h1>
          <p class="box">&quot;To be the most recognised and trusted  organisation worldwide in the fields of diver safety and emergency services, 
		  health, research and education of its members, instructors, supporters and the  recreational diving community at large&quot;</p>
	      <div class="imageCenter"><img src="../_images/DAN_logo2.jpg" alt="DAN Logo" width="200" height="89" class="imgCenter" /></div>
		  <div .class="center"><h3 align="center"><a href="../_pdf/memorandum.pdf">Read DAN Asia-Pacific's Memorandum of Association</a></h3>
		  </div>
		  <p>&nbsp;</p>
