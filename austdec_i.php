...
<title>DAN Divers Alert Network - Asia Pacific : Membership and Insurance for Diving Accidents for Scuba Divers</title>
<!-- InstanceEndEditable -->
...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
	    <div id="content">
	      ...
	      <h5>Do you intend to travel or live outside Australia for longer than 3 months? <a href="non_nat_aust.php">LEARN MORE</a></h5>
          
          <div class="center">
	        <table width="350" height="90" border="0">
            <tr>
              <td><div align="center">
                <p><a id="applyonline" href="https://www.danasiapacific.org/main/mforms/au-n_membershipform_i.php">Click Here  To Apply On-Line</a></p>
              </div></td>
            ...
            <tr>
			 ...
			 <h5><strong>Browser Problem </strong></h5>
			 ...
			 <p>The Dolphin browser (free at the App Store) is compatible with  DAN's online application.</p><br />
		  
	      <p class="fine">The FAX form requires Acrobat Reader, click on the image to download Acrobat Reader</p>
          <a href="http://www.adobe.com/products/acrobat/readstep2.html"><img src="../_images/get_adobe_reader.gif" alt="Get Acrobat Reader" width="112" height="33" border="0" /></a>
