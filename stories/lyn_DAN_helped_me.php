...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      <div id="content">
        ...
        <h3><em>          Continued from Deeper with DAN Issue 19 </em></h3>
        ...
        <p align="justify">On Tuesday morning, although the rash was improved I still  had some pain so my husband spoke again to the captain and suggested that  although it might not be a bend, that some oxygen was <em>'worth a try, just in  case&rsquo;</em>. The captain agreed to this. It was discovered that their &ldquo;emergency&rdquo;  oxygen cylinder was empty so some was decanted from their Nitrox supply. I  spent around an hour breathing this. I improved a little more during the  day, although it wasn&rsquo;t immediate enough to be clearly attributable to the  oxygen.</p>
        <p align="justify"> It was on this day we discovered that two of the other  divers aboard were doctors. They heard about my problem and asked to examine  me. The doctors were unable to give any definite diagnosis although a bend was  considered one possibility and their advice was to continue not to dive.</p>
        ...
        <p align="justify">Consequently on Thursday I undertook three dives, each  around 50 minutes. It was great to be back in the water! We dived with the rest of  the group but when the others descended the wall, we stayed relatively shallow  to a maximum depth of 18m.</p>
	    ...
	    <p align="justify">	      Unbelievably, when we reported this to the captain and  asked for more oxygen, he still insisted it was not a bend! He suggested a  number of possibilities, such as an allergy again, a pulled muscle, a too tight  wetsuit: Basically anything (and everything) but a bend. By now, however, we  had finally woken up to the possible seriousness of the situation and insisted  on immediate oxygen. Plus, we would call  DAN as soon as we were within phone  range early that evening.</p>
	    <h2>Why We Didn't Call DAN Sooner</h2>
        <p>There were a number of reasons why we hadn&rsquo;t made the call sooner. </p>
        <ol start="1" type="1">
          <li>We were       being told by people, whose expertise we were relying on, that I wasn&rsquo;t       bent. </li>
          <li>We felt       that we had some backup given there were doctors on board who could step       in if things got worse.</li>
          <li>We had       thought it &ldquo;too big a step&rsquo; when we weren&rsquo;t even sure it was a bend. We       had read many cases published by DAN where heroic measures were taken to       evacuate and treat bent cases. We were worried if we rang that the doctors       might just cover themselves and insist on expensive and inconvenient       evacuation and treatment just to be sure. </li>
        </ol>
        <p align="justify">I&rsquo;m pleased to say our concerns were entirely unfounded. We  made that call and after a short discussion with an on-call doctor, we were  soon phoned back by John Lippmann, the Executive Director of DAN AP. <br />
        ...
        <p align="justify">          John suggested that the best thing would be to visit the  nearby hospital and chamber on disembarking the boat but when we explained our  concern at probably missing our international flight he gave us an alternative.  Our flight to Kuala Lumpur was not until Saturday night so we could see how the  symptoms went after the overnight oxygen and during the course of the next day.  If all seemed well, we could make a choice to risk the short flight to KL and  if any symptoms reoccurred on the flight we could go straight to the chamber on  arrival. If no symptoms reoccurred we were probably fine to catch our international  flight on Monday night.</p>
        <p align="justify">          As it happens, this is the course we took. I was feeling  good after the overnight oxygen and we caught the flight to KL and then back  home to Australia without incident. Amazingly, John rang me the next morning and also on my  arrival in KL to check on my wellbeing! He also contacted me on my arrival back  home to explain I should investigate the possibility that I have a PFO, which  makes people more susceptible to the bends. He even suggested a doctor to  contact and the tests I should have.</p>
        <h2>Lesson's Learnt </h2>
        <p>We are lucky that everything worked out fine, but we did  learn some important lessons from this experience:</p>
        <p><strong>1. No matter how  expensive the trip or how tempting the diving, don&rsquo;t dive if you have doubts.</strong> Don&rsquo;t convince yourself you are fine &ndash; get expert advice and rely on it.</p>
        <p><strong>2. Don&rsquo;t consider  the captain, the divemaster or anyone else on the boat as the expert.</strong> You  are responsible for yourself and you should get proper advice. Even competent  and well-meaning doctors probably don&rsquo;t have the expertise to properly diagnose  or treat diving injuries.</p>
        <p>            <strong>3. Ensure your  liveaboard or resort has properly maintained equipment available for  emergencies.</strong> Consider where the closest chamber is and ensure you are  insured for the cost of evacuation and treatment.</p>
        <p>          <strong>4. Ring DAN as soon  as you have ANY concerns.</strong> You will get prompt, friendly and expert advice.  If you are fine or there is a minor problem they will tell you that. If there  is a serious problem you are going to be even more glad you called them!</p>
        <h1>Comment from DAN AP Executive Director, John Lippmann </h1>
        <p align="justify">It really comes as no great surprise to me to hear of  Lyn&rsquo;s initial problems arising after her second morning of diving where she did  three 50-minute dives to around 30 m in close succession. These dives would  accumulate quite a lot of inert gas and relatively little time to eliminate  this, despite the dive computer indicating that all is OK. </p>
        <p align="justify">It was a sensible action to refrain from diving and the  divemaster/skipper should have readily provided oxygen to her and a DAN hotline  should have been promptly contacted for advice, as Lyn now knows. </p>
        <p align="justify">It is inappropriate and unwise for a divemaster/skipper to  try to withhold oxygen because they do not think a diver is suffering from DCI.  Fortunately, Lyn did not deteriorate badly, but she potentially could have,  especially with further diving which can sometimes turn a mild DCI into a very  serious one unless very well-managed.&nbsp;&nbsp;&nbsp; </p>
        <p align="justify">By the time we were contacted we were of the belief that  Lyn&rsquo;s symptoms were abating and were unlikely to worsen. However, flying can  sometimes exacerbate the problem and we needed to have a strategy in place to  deal with any problem if it arose. Fortunately it didn&rsquo;t and Lyn returned home  safely.</p>
        <p align="justify">As Lyn mentioned, I linked her with a diving medical  specialist for a review and to decide whether it was worthwhile checking for a  patent foramen ovale (PFO). Lyn has advised she will be undergoing PFO testing in July.</p>
