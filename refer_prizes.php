...
<div id="croot">
 	...
 	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="content_body" -->
      ...
      <h1>DAN's 'Refer a Friend' Prize Pool</h1>

        <h3><strong>Scubapro MK21</strong></h3>

        <p>A new compact balanced piston-controlled first stage. Compact in size but not in features, this modern striking first stage has a &quot;smart&quot; hose layout for perfect positioning and easy identification.</p>

        <h3 align="left"><strong>Scubapro S560</strong></h3>

        <p align="left">A lightweight, techno-polymer barrel second stage. The S560 is air balanced with diver adjustable inhalation effort and VIVA ensuring effortless and smooth breathing in all conditions. </p>

        <h3><strong>Scubapro Meridian</strong> Dive Watch</h3>

        <p>Engineered by divers for divers. The Meridian performs advanced functions in a timeless style above and below the surface.</p>

        <h3><strong>Scubapro Nova 230 Torch </strong></h3>

        <p>A medium-sized aluminium case, high-intensity led light with a burn time of 8 to 10 hours. The perfect primary light for recreational diving or backup for more technical dives.</p>

        <h3><strong>Ningaloo Reef Whaleshark Tour</strong></h3>

        <p>One winner will win an unforgettable day on board Exmouth Diving Centres 

          18M boat &ldquo;<em>Mahi Mahi 2</em>&rdquo;. The tour includes morning tea, lunch,afternoon tea and refreshments throughout the day. </p>

        <h3><strong>DAN Merchandise</strong></h3>

        <p>5 Members will win goody bags with a  great range of DAN products.</p>

        <h1>Remember, entry is simple. All you need to do is Refer a Friend. Don't Miss Out!</h1>
